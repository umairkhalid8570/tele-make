(function () {
    ...
    async function checkModules() {
        ...
        await tele.__DEBUG__.didLogInfo;
        const info = tele.__DEBUG__.jsModules;
    ...
    QUnit.begin(function () {
        if (tele.__DEBUG__.services["@web/core/errors/error_utils"]) {
            const errorUtils = tele.__DEBUG__.services["@web/core/errors/error_utils"];
