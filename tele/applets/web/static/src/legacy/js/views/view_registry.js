tele.define('web.view_registry', function (require) {
"use strict";
 ...
 * Views defined in other applets should be added in this registry as well,
...
tele.define('web._view_registry', function (require) {
"use strict";
