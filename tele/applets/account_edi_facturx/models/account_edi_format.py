...
from tele.tools import DEFAULT_SERVER_DATE_FORMAT, float_repr, is_html_empty, str2bool
from tele.tests.common import Form
from tele.exceptions import RedirectWarning, UserError
...
class AccountEdiFormat(models.Model):
    ...
    def _prepare_invoice_report(self, pdf_writer, edi_document):
        ...
        pdf_writer.embed_tele_attachment(edi_document.attachment_id, subtype='text/xml')
    ...
    def _import_facturx(self, tree, invoice):
        ...
        with Form(invoice.with_context(default_move_type=default_move_type)) as invoice_form:
            ...
            if elements:
                ...
                # Fallback for old invoices from tele where the InvoiceCurrencyCode was not present
            else:
