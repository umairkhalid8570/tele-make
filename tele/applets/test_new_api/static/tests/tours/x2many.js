tele.define('web.test.x2many', function (require) {
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////
    {
        ...
        trigger: 'tr:has(td:containsExact(Tele Admin)) .o_list_record_selector input[type="checkbox"]'
    }, {
        content: "save selected participants",
        trigger: '.o_select_button',
        extra_trigger: 'tr:has(td:containsExact(Tele Admin)) .o_list_record_selector input[type="checkbox"]:propChecked',
    }, { // save
        content: "save discussion",
        trigger: 'button.o_form_button_save',
        extra_trigger: '.o_form_sheet .tab-pane:eq(2) .o_field_widget tbody tr:has(td:containsExact(Tele Admin))',
    }, { // edit
        ...
        extra_trigger: '.o_web_client:has(textarea[name="message_concat"]:propValue([test] Tele Admin:a))',
    }, {
        ...
        content: "insert content",
        trigger: 'input.o_required_modifier',
        extra_trigger: 'textarea[name="message_concat"]:first:propValue([test] Tele Admin:a\n[test] Tele Admin:b)',
        ...
        trigger: 'textarea[name="message_concat"]:first:propValue([test_trigger] Tele Admin:a\n[test_trigger] Tele Admin:b)',
        run: function () {},
    }, { // change message b
        ...
        trigger: '.tab-pane:eq(0) .o_field_x2many_list_row_add a',
        extra_trigger: 'textarea[name="message_concat"]:propValue([test_trigger] Tele Admin:a\n[test_trigger] Tele Admin:bbb)',
    }, {
        content: "insert body",
        trigger: 'textarea[name="body"]:first',
        run: 'text c',
        ...
        trigger: '.o_content:has(.tab-pane:eq(0) .o_field_widget tr:has(td:containsExact(bbb)):has(td:containsExact([test_trigger] Tele Admin)))',
        run: function () {}, // it's a check
    }, {
        ...
        trigger: 'textarea[name="message_concat"]:first:propValueContains([test_trigger] Tele Admin:e)',
        in_modal: false,
        ...
        trigger: '.o_content:has(.tab-pane:eq(0) .o_field_widget tbody tr:has(td:containsExact([test_trigger] Tele Admin)):has(td:containsExact(aaa)))',
        run: function () {}, // it's a check
    }, {
        ...
        trigger: 'textarea[name="message_concat"]:propValueContains([test_trigger] Tele Admin:aaa\n[test_trigger] Tele Admin:c\n[test_trigger] Tele Admin:d\n[test_trigger] Tele Demo:ddd)',
        run: function () {}, // don't change texarea content
    }, {
...

    {
        ...
        trigger: '.o_content:not(:has(textarea[name="message_concat"]:propValueContains(Tele Admin:d)))',
        run: function () {},
    }, { // save
        content: "save discussion",
        trigger: 'button.o_form_button_save',
        ...
        trigger: '.o_field_text:containsExact([test_trigger2] Tele Admin:aaa\n[test_trigger2] Tele Demo:ccccc)',
        run: function () {}, // don't change texarea content
    }, {
        ...
        trigger: '.o_field_text[name="message_concat"]:containsExact([test_trigger2] Tele Admin:aaa\n[test_trigger2] Tele Demo:ccccc\n[test_trigger2] Tele Admin:eee)',
        run: function () {}, // it's a check
    }, {
