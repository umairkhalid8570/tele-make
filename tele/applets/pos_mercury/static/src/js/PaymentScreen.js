tele.define('pos_mercury.PaymentScreen', function (require) {
    'use strict';
    ...
    const PosMercuryPaymentScreen = (PaymentScreen) =>
        class extends PaymentScreen {
            constructor() {
                ...
                // How long we wait for the tele server to deliver the response of
                ...
                this.rpc(
                    ...
                    .then(function (data) {
                        ...
                        if (data === 'internal error') {
                            def.resolve({
                                message: self.env._t('Tele error while processing transaction.'),
                            });
                            return;
                        }
