...
import tele
import tele.service.server as servermod
from tele import api, fields, models, SUPERUSER_ID
...
class ImDispatch:
    ...
    def poll(self, dbname, channels, last, options=None, timeout=None):
        ...
        if not tele.evented:
            ...
            current.name = f"tele.longpolling.request.{current.ident}"
...
if not tele.multi_process or tele.evented:
