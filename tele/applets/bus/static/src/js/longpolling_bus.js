tele.define('bus.Longpolling', function (require) {
"use strict";
...
var LongpollingBus = Bus.extend(ServicesMixin, {
    ...
    /**
     * Tell whether tele is focused or not
     *
     * @returns {boolean}
     */
    isTeleFocused: function () {
        return this._isTeleFocused;
    },
    /**
    ...
    _onFocusChange: function (params) {
        this._isTeleFocused = params.focus;
        if (params.focus) {
            this._lastPresenceTime = new Date().getTime();
            this.trigger('window_focus', this._isTeleFocused);
        }
    },
    /**
