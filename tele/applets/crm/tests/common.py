...
from tele.applets.crm.models.crm_lead import CRM_LEAD_FIELDS_TO_MERGE
from tele.applets.mail.tests.common import MailCase, mail_new_test_user
...
class TestLeadConvertCommon(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.crm_lead_dt_patcher = patch('tele.applets.crm.models.crm_lead.fields.Datetime', wraps=Datetime)
