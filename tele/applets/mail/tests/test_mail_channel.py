...
class TestChannelInternals(MailCommon):
    ...
    def test_channel_should_generate_correct_default_avatar(self):
        ...
        expceted_avatar_channel = (channel_avatar.replace('fill="#136dc7"', f'fill="{bgcolor}"')).encode()
        expected_avatar_group = (group_avatar.replace('fill="#136dc7"', f'fill="{bgcolor}"')).encode()
