...
from tele.applets.partner_autocomplete.tests.common import MockIAPPartnerAutocomplete
...
class TestResCompany(common.TransactionCase, MockIAPPartnerAutocomplete):
    ...
    def test_extract_company_domain(self):
        ...
        company_1.website = "http://runbot.tele.studio"
        self.assertEqual(company_1._get_company_domain(), 'tele.studio')
