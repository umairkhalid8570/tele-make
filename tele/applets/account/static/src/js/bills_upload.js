tele.define('account.upload.bill.mixin', function (require) {
"use strict";
...
tele.define('account.bills.tree', function (require) {
"use strict";
    var core = require('web.core');
...
tele.define('account.bills.kanban', function (require) {
...
tele.define('account.dashboard.kanban', function (require) {
"use strict";
    var core = require('web.core');
    var KanbanController = require('web.KanbanController');
    var KanbanView = require('web.KanbanView');
