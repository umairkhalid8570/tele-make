...
from tele.osv.expression import FALSE_DOMAIN
from tele.applets.http_routing.models import ir_http
from tele.applets.http_routing.models.ir_http import _guess_mimetype
...
class Http(models.AbstractModel):
    ...
    def _dispatch(cls):
        """
        In case of rerouting for translate (e.g. when visiting tele.studio/fr_BE/),
            ...
            if (
                ...
                try:
                    ...
                    if r['time'] + page.cache_time > time.time():
                        response = tele.http.Response(r['content'], mimetype=r['contenttype'])
