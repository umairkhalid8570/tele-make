...
from tele import http, models, fields, _
from tele.http import request
from tele.osv import expression
from tele.tools import OrderedSet, escape_psql, html_escape as escape
from tele.applets.http_routing.models.ir_http import slug, slugify, _guess_mimetype
...
class Website(Home):
    ...
    def website_info(self, **kwargs):
        ...
        values = {
            'apps': apps,
            'l10n': l10n,
            'version': tele.service.common.exp_version()
        }
