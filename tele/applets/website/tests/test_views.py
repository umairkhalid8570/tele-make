...
from tele.tests import common, HttpCase, tagged
...
class TestThemeViews(common.TransactionCase):
    def test_inherit_specific(self):
        ...
        new_arch = '<xpath expr="//body" position="replace"><span>Tele Change01</span></xpath>'
        ...
        new_arch = '<xpath expr="//body" position="replace"><span>Tele Change02</span></xpath>'
        theme_view.arch = new_arch
        test_theme_module.with_context(load_all_views=True)._theme_load(website_1)
        ...
        new_arch = '<xpath expr="//body" position="replace"><span>Tele</span></xpath>'
