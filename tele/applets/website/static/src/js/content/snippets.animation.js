tele.define('website.content.snippets.animation', function (require) {
'use strict';
...
registry.mediaVideo = publicWidget.Widget.extend(MobileYoutubeAutoplayMixin, {
    ...
    start: function () {
        ...
        // integrated with Tele (this refactoring should be done in master).
        ...
        // videos added before bug fixes or new Tele versions where the
