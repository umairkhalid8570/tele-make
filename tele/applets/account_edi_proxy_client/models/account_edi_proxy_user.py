...
from .account_edi_proxy_auth import TeleEdiProxyAuth
...
DEFAULT_SERVER_URL = 'https://l10n-it-edi.api.tele.studio'
DEFAULT_TEST_SERVER_URL = 'https://iap-services-test.tele.studio'
TIMEOUT = 30
    ...
    def _make_request(self, url, params=False):
        ...
        try:
            response = requests.post(
                ...
                auth=TeleEdiProxyAuth(user=self)).json()
