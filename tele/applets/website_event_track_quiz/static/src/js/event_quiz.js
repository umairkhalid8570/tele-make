 ...
 *
 * This widget can be attached to DOM rendered server-side by `recognition_quiz.`
 *
 */
...
publicWidget.registry.Quiz = publicWidget.Widget.extend({
     ...
     * relative answers.
     * This method should return the same format as /recognition_quiz/quiz/get controller.
     *
