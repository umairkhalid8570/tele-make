...
from tele.applets.sales_team.tests.common import TestSalesMC
from tele.tests.common import users, TransactionCase
...
class TestCornerCases(TransactionCase):
    ...
    def test_unicity(self):
        ...
        with self.assertRaises(exceptions.UserError), mute_logger('tele.sql_db'):
