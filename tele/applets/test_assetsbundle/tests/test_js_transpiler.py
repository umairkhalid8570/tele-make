...
from tele.tools import transpile_javascript
...
class TestJsTranspiler(TransactionCase):
    ...
    def test_01_alias(self):
        input_content = """/** @tele-module alias=test_assetsbundle.Alias **/"""
        result = transpile_javascript("/test_assetsbundle/static/src/alias.js", input_content)

        expected_result = """tele.define('@test_assetsbundle/alias', async function (require) {
'use strict';
let __exports = {};
/** @tele-module alias=test_assetsbundle.Alias **/
return __exports;
});

tele.define(`test_assetsbundle.Alias`, async function(require) {
...
"""
    ...
    def test_02_default(self):
        input_content = """/** @tele-module alias=test_assetsbundle.Alias default=False **/"""
        result = transpile_javascript("/test_assetsbundle/static/src/alias.js", input_content)

        expected_result = """tele.define('@test_assetsbundle/alias', async function (require) {
'use strict';
let __exports = {};
/** @tele-module alias=test_assetsbundle.Alias default=False **/
return __exports;
});
...
"""
        ...
        input_content = """/** @tele-module alias=test_assetsbundle.Alias default=0 **/"""
        result = transpile_javascript("/test_assetsbundle/static/src/alias.js", input_content)

        expected_result = """tele.define('@test_assetsbundle/alias', async function (require) {
'use strict';
let __exports = {};
/** @tele-module alias=test_assetsbundle.Alias default=0 **/
return __exports;
});
...
"""
        ...
        expected_result = """tele.define('@test_assetsbundle/classes', async function (require) {
'use strict';
let __exports = {};
...
"""
        ...
        expected_result = """tele.define('@test_assetsbundle/comments', async function (require) {
'use strict';
let __exports = {};
/**
 * This is a comment
...
"""
        ...
        expected_result = """tele.define('@test_assetsbundle/functions', async function (require) {
'use strict';
let __exports = {};
...
"""
        ...
        expected_result = """tele.define('@test_assetsbundle/import', async function (require) {
'use strict';
let __exports = {};
/**
 * import { Dialog, Notification } from "../src/Dialog";
...
import d from "@tests";"""
        ...
        expected_result = """tele.define('@test_assetsbundle', async function (require) {
'use strict';
let __exports = {};
...
"""
        ...
        expected_result = """tele.define('@test_assetsbundle/list', async function (require) {
'use strict';
let __exports = {};
...
"""
        ...
        expected_result = """tele.define('@test_assetsbundle/variables', async function (require) {
'use strict';
let __exports = {};
