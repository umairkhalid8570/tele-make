...
from tele.modules import get_modules, get_module_path
...
class TestPyLint(TransactionCase):
    ...
    def test_pylint(self):
        ...
        for module in get_modules():
            ...
            if not module_path.startswith(join(tools.config['root_path'], 'applets')):
        ...
        options = [
            ...
            '--load-plugins=pylint.extensions.bad_builtin,_tele_checker_sql_injection,_tele_checker_gettext,_tele_checker_unlink_override',
