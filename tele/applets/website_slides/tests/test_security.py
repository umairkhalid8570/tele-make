...
from tele.applets.website_slides.tests import common
...
class TestAccess(common.SlidesCase):
    ...
    @mute_logger('tele.models', 'tele.applets.base.models.ir_rule')
...
class TestAccessFeatures(common.SlidesCase):
    ...
    @mute_logger('tele.models.unlink', 'tele.applets.base.models.ir_rule', 'tele.applets.base.models.ir_model')
