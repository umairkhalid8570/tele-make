tele.define('website_sale_tour.tour', function (require) {
    'use strict';
    ...
    },
    {
        ...
        run: function () {
            ...
            $('input[name="email"]').val('abc@tele.studio');
    ...
    },
    {
        ...
        trigger: '.oe_login_form',
        run: function () {
            $('.oe_login_form input[name="login"]').val("abc@tele.studio");
    ...
    },
    {
        ...
        trigger: '#top_menu li.dropdown:visible a:contains("Tele Admin")',
    },
    {
        content: "Logout",
        trigger: '#o_logout:contains("Logout")',
