...
from tele.applets.crm.models import crm_stage
from tele.exceptions import ValidationError

_logger = logging.getLogger(__name__)

DEFAULT_ENDPOINT = 'https://iap-services.tele.studio'
...
class CRMRevealRule(models.Model):
    ...
    industry_tag_ids = fields.Many2many('crm.iap.lead.industry', string='Industries', help='Leave empty to always match. Tele will not create lead if no match')
    ...
    def _create_lead_from_response(self, result):
        ...
        template_values.update({
            'flavor_text': _("Opportunity created by Tele Lead Generation"),
    ...
    # Methods responsible for format response data in to valid tele lead data
