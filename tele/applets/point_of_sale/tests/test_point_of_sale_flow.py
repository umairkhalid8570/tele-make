...
import tele
from tele import fields, tools
from tele.tools import float_compare, mute_logger, test_reports
from tele.tests.common import Form
from tele.applets.point_of_sale.tests.common import TestPointOfSaleCommon
...
class TestPointOfSaleFlow(TestPointOfSaleCommon):
    ...
    def test_create_from_ui(self):
        ...
        with mute_logger('tele.applets.point_of_sale.models.pos_order'):
