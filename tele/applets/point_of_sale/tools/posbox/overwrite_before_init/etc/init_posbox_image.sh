...
wget 'https://nightly.tele.studio/master/iotbox/eftdvs' -P /usr/local/bin/
chmod +x /usr/local/bin/eftdvs
wget 'https://nightly.tele.studio/master/iotbox/eftapi.so' -P /usr/lib/

groupadd usbusers
usermod -a -G usbusers pi
usermod -a -G lp pi
usermod -a -G input lightdm
mkdir -v /var/log/tele
chown pi:pi /var/log/tele
chown pi:pi -R /home/pi/tele/
...
echo "* * * * * rm /var/run/tele/sessions/*" | crontab -
...
echo "applets/hw_drivers/iot_devices/" > /home/pi/tele/.git/info/exclude
