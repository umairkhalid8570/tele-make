...
class GoogleCalendarController(http.Controller):
    ...
    def sync_data(self, model, **kw):
        """ This route/function is called when we want to synchronize Tele
            ...
            The dictionary may contains an url, to allow Tele Client to redirect user on
        ...
        if model == 'calendar.event':
            ...
            # Checking that user have already accepted Tele to access his calendar !
