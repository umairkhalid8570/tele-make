...
from tele.http import Controller, dispatch_rpc, request, route
from tele.service import wsgi_server
from tele.fields import Date, Datetime, Command
from tele.tools import lazy, ustr
from tele.tools.misc import frozendict


# ustr decodes as utf-8 or latin1 so we can search for the ASCII bytes
# 	Char	   ::=   	#x9 | #xA | #xD | [#x20-#xD7FF]
XML_INVALID = re.compile(b'[\x00-\x08\x0B\x0C\x0F-\x1F]')
class TeleMarshaller(xmlrpc.client.Marshaller):
    ...
    # Historically, tele is sending binary as base64 string.
...
xmlrpc.client.Marshaller = TeleMarshaller
...
class RPC(Controller):
    ...
    def jsonrpc(self, service, method, args):
        """ Method used by client APIs to contact Tele. """
