...
class Company(models.Model):
    ...
    def _get_logo(self):
        return base64.b64encode(open(os.path.join(tools.config['root_path'], 'applets', 'base', 'static', 'img', 'res_company_logo.png'), 'rb') .read())
    ...
    # performance reasons (see applets/web/controllers/main.py, Binary.company_logo)
