...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - tele/applets/test_access_rights/tests/test_feedback.py
        # - tele/applets/test_access_rights/tests/test_ir_rules.py
        # - tele/applets/base/tests/test_orm.py (/home/dle/src/tele/master-nochange-fp/tele/applets/base/tests/test_orm.py)
        self.flush()
        self.clear_caches()
        return res
