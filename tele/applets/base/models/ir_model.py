...
from tele import api, fields, models, tools, _, Command
from tele.exceptions import AccessError, UserError, ValidationError
from tele.osv import expression
from tele.tools import pycompat, unique, OrderedSet
from tele.tools.safe_eval import safe_eval, datetime, dateutil, time
...
class IrModel(models.Model):
    ...
    def unlink(self):
        ...
        # reload is done independently in tele.modules.loading.
...
class IrModelConstraint(models.Model):
    """
    This model tracks PostgreSQL foreign keys and constraints used by Tele
    models.
    """
...
class IrModelRelation(models.Model):
    """
    This model tracks PostgreSQL tables used to implement Tele many2many
    relations.
    """
...
class IrModelData(models.Model):
    """Holds external identifier keys for records in the database.
       This has two main uses:
           ...
           * allows tracking the origin of data installed by Tele
    ...
    # NOTE: this method is overriden in tele_studio; if you need to make another
