...
from tele.applets.base.models.ir_mail_server import extract_rfc2822_addresses
from tele.tests.common import BaseCase, TransactionCase
from tele.tools import (
...
class EmailConfigCase(TransactionCase):
    @patch.dict("tele.tools.config.options", {"email_from": "settings@example.com"})
