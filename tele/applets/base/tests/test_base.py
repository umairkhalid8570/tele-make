...
from tele import SUPERUSER_ID, Command
...
from tele.tools.safe_eval import safe_eval, const_eval, expr_eval
...
class TestSafeEval(BaseCase):
    ...
    @mute_logger('tele.tools.safe_eval')
    def test_05_safe_eval_forbiddon(self):
        ...
        with self.assertRaises(ValueError):
            safe_eval("import tele", mode="exec")
