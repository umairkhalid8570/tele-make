...
EDI_LIKE_HTML_SOURCE = u"""<div style="font-family: 'Lucida Grande', Ubuntu, Arial, Verdana, sans-serif; font-size: 12px; color: rgb(34, 34, 34); background-color: #FFF; ">
    ...
    <div style="width: 347px; margin: 0px; padding: 5px 14px; line-height: 16px; background-color: #fcfcfc;">
...
<div class="WordSection1">
        ...
        <pre>U.S.: +1 (858) 315-2345<p></p></pre>
...
<div style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'; COLOR: #000000">
    ...
    <div>&nbsp;</div>
    <div class="tele tele_webclient_container oe_webclient">
...
REMOVE_CLASS_OUT = [
    ...
    u'<div class="modal-content tele">',
