tele.define('web_editor.test_utils', function (require) {
"use strict";

var ajax = require('web.ajax');
var MockServer = require('web.MockServer');
var testUtils = require('web.test_utils');
var TeleEditorLib = require('@web_editor/../lib/tele-editor/src/TeleEditor');
...
var testKeyboard = function ($editable, assert, keyboardTests, addTests) {
    ...
    function nextPoint(point) {
        var node, offset;
        if (TeleEditorLib.nodeSize(point.node) === point.offset) {
            node = point.node.parentNode;
            offset = TeleEditorLib.childNodeIndex(point.node) + 1;
