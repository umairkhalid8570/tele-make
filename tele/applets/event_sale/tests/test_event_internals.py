...
from tele.applets.event_sale.tests.common import TestEventSaleCommon
...
class TestEventTicketData(TestEventSaleCommon):
    ...
    def setUp(self):
        ...
        self.ticket_datetime_patcher = patch('tele.applets.event.models.event_event.fields.Datetime', wraps=FieldsDatetime)
