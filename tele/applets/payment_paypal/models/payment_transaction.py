...
from tele.applets.payment_paypal.const import PAYMENT_STATUS_MAPPING
from tele.applets.payment_paypal.controllers.main import PaypalController
...
class PaymentTransaction(models.Model):
    ...
    paypal_type = fields.Char(
        string="PayPal Transaction Type", help="This has no use in Tele except for debugging.")
