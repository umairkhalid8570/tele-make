...
from tele.applets.microsoft_calendar.models.res_users import User
from tele.applets.microsoft_calendar.utils.event_id_storage import combine_ids
from tele.applets.microsoft_calendar.tests.common import TestCommon, mock_get_token, _modified_date_in_the_future, patch_api
...
class TestUpdateEvents(TestCommon):
    ...
    # -------------------------------------------------------------------------------
    # Update from Tele to Outlook
    # -------------------------------------------------------------------------------

    # ------ Simple event ------

    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_tele_simple_event_without_sync(self, mock_patch):
        """
        Update an Tele event without Outlook sync enabled
        """
    ...
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_simple_event_from_tele(self, mock_patch):
        """
        Update an Tele event with Outlook sync enabled
        """
    ...
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_simple_event_from_tele_attendee_calendar(self, mock_patch):
        """
        Update an Tele event from the attendee calendar.
        """
    ...
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_name_of_one_event_of_recurrence_from_tele(self, mock_patch):
        """
        Update one Tele event name from a recurrence from the organizer calendar.
        """
    ...
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_start_of_one_event_of_recurrence_from_tele(self, mock_patch):
        """
        Update one Tele event start date from a recurrence from the organizer calendar.
        """
    ...
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_start_of_one_event_of_recurrence_from_tele_with_overlap(self, mock_patch):
        """
        Update one Tele event start date from a recurrence from the organizer calendar, in order to
    ...
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_name_of_one_event_of_recurrence_from_tele_attendee_calendar(self, mock_patch):
        """
        Update one Tele event name from a recurrence from the atendee calendar.
        """
    ...
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_name_of_one_and_future_events_of_recurrence_from_tele(
        self, mock_patch, mock_insert, mock_delete
    ):
        """
        Update a Tele event name and future events from a recurrence from the organizer calendar.
        """
    ...
    @patch.object(MicrosoftCalendarService, 'insert')
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_start_of_one_and_future_events_of_recurrence_from_tele(
        self, mock_patch, mock_insert, mock_delete
    ):
        """
        Update a Tele event start date and future events from a recurrence from the organizer calendar.
        """
    ...
    @patch.object(MicrosoftCalendarService, 'insert')
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_start_of_one_and_future_events_of_recurrence_from_tele_with_overlap(
        self, mock_patch, mock_insert, mock_delete
    ):
        """
        Update a Tele event start date and future events from a recurrence from the organizer calendar,
    ...
    @patch.object(MicrosoftCalendarService, 'insert')
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_one_and_future_events_of_recurrence_from_tele_attendee_calendar(
        self, mock_patch, mock_insert, mock_delete
    ):
        """
        Update a Tele event name and future events from a recurrence from the attendee calendar.
        """
    ...
    @patch.object(MicrosoftCalendarService, 'insert')
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_name_of_all_events_of_recurrence_from_tele(
        self, mock_patch, mock_insert, mock_delete
    ):
        """
    ...
    @patch.object(MicrosoftCalendarService, 'insert')
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_start_of_all_events_of_recurrence_from_tele(
        self, mock_patch, mock_insert, mock_delete
    ):
        """
    ...
    @patch.object(MicrosoftCalendarService, 'insert')
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_all_events_of_recurrence_from_tele_attendee_calendar(
        self, mock_patch, mock_insert, mock_delete
    ):
        """
