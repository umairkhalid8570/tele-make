...
class m(models.Model):
    ...
    def generate_redirect_warning(self):
        ...
        raise tele.exceptions.RedirectWarning('description', action.id, 'Go to the redirection')

    def generate_access_denied(self):
        raise tele.exceptions.AccessDenied()

    def generate_access_error(self):
        raise tele.exceptions.AccessError('description')
    ...
    def generate_user_error(self):
        raise tele.exceptions.UserError('description')

    def generate_missing_error(self):
        raise tele.exceptions.MissingError('description')

    def generate_validation_error(self):
        raise tele.exceptions.ValidationError('description')
