...
from tele.modules import load_information_from_description_file
from tele.tools import convert_file, exception_to_unicode
...
class IrModule(models.Model):
    ...
    def _import_module(self, module, path, force=False):
        ...
        if unmet_dependencies:
            if (unmet_dependencies == set(['tele_studio']) and
            ...
            raise UserError(err)
        elif 'tele_studio' not in installed_mods and _is_studio_custom(path):
            raise UserError(_("Studio customizations require the Tele Studio app."))
    ...
    def import_zipfile(self, module_file, force=False):
        ...
        with zipfile.ZipFile(module_file, "r") as z:
            ...
            with tempfile.TemporaryDirectory() as module_dir:
                import tele.modules.module as module
                try:
                    tele.applets.__path__.append(module_dir)
                    ...
                    tele.applets.__path__.remove(module_dir)
