...
from tele import fields, http, SUPERUSER_ID, _
from tele.applets.base.models.ir_ui_view import keep_query
from tele.exceptions import UserError
from tele.http import request, content_disposition
from tele.osv import expression
from tele.tools import format_datetime, format_date, is_html_empty
