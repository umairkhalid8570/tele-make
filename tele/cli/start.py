...
from tele.modules.module import get_module_root, MANIFEST_NAMES
from tele.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the Tele server for your project"""
    ...
    def run(self, cmdargs):
        ...
        if mods and '--applets-path' not in cmdargs:
            cmdargs.append('--applets-path=%s' % project_path)
        ...
        try:
            ...
            tele.tools.config['init']['base'] = True
