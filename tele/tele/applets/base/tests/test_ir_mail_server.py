...
from tele.applets.base.tests import test_mail_examples
...
class TestIrMailServer(TransactionCase, MockSmtplibCase):
    ...
    def test_mail_server_priorities(self):
        ...
        # remove the notifications email to simulate a mis-configured Tele database
        ...
        with mute_logger('tele.applets.base.models.ir_mail_server'):
    ...
    @mute_logger('tele.models.unlink')
    @patch.dict("tele.tools.config.options", {"from_filter": "test.com"})
    def test_mail_server_binary_arguments_domain(self):
        """Test the configuration provided in the tele-make arguments.
        ...
        # Remove all mail server so we will use the tele-make arguments
    ...
    def test_mail_server_mail_default_from_filter(self):
        """Test that the config parameter "mail.default.from_filter" overwrite the tele-make
