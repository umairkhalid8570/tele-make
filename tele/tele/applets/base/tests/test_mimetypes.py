...
from tele.tools.mimetypes import guess_mimetype, get_extension
...
class test_guess_mimetype(BaseCase):
    ...
    def test_default_mimetype_empty(self):
        ...
        # tele implementation returns application/octet-stream by default
    ...
    def test_mimetype_svg(self):
        ...
        # Tests that whitespace padded SVG are not detected as SVG in tele implementation
        if not magic:
