...
from tele.tools.misc import file_open, mute_logger
from tele.tools.translate import _, _lt, TranslationFileReader, TranslationModuleReader
...
class TestTermCount(common.TransactionCase):
    ...
    def test_count_term(self):
        ...
        tele.tools.trans_load(self.cr, 'test_translation_import/i18n/fr.po', 'fr_FR', verbose=False)
        ...
        self.assertEqual(translations[0].name, 'applets/test_translation_import/models.py')
    ...
    def test_noupdate(self):
        ...
        tele.tools.trans_load(self.cr, 'test_translation_import/i18n/fr.po', 'fr_FR', verbose=False, overwrite=True)
    ...
    def test_lang_with_base(self):
        ...
        tele.tools.trans_load(self.cr, 'test_translation_import/i18n/fr.po', 'fr_BE', verbose=False)
        tele.tools.trans_load(self.cr, 'test_translation_import/i18n/fr_BE.po', 'fr_BE', verbose=False, overwrite=True)
    ...
    def test_export_empty_string(self):
        ...
        def update_translations(create_empty_translation=False):
            ...
            with closing(io.BytesIO()) as bufferobj:
                tele.tools.trans_export('fr_FR', ['test_translation_import'], bufferobj, 'po', self.cr)
                bufferobj.name = 'test_translation_import/i18n/fr.po'
                tele.tools.trans_load_data(self.cr, bufferobj, 'po', 'fr_FR',
                                           verbose=False,
    ...
    def test_import_from_po_file(self):
        ...
        with mute_logger('tele.applets.base.models.res_lang'):
    ...
    def test_translation_placeholder(self):
        ...
        translation = self.env['ir.translation'].create({
            ...
            'type': 'code',
            'name': 'applets/test_translation_import/tests/test_count_term.py',
            'res_id': 0,
            'lang': 'fr_BE',
        })
        ...
        with self.assertLogs('tele.tools.translate', 'ERROR'):
            self.assertEqual(
                _("Text with %s placeholder", 1),
...
class TestTranslationFlow(common.TransactionCase):
    ...
    def test_export_static_templates(self):
        ...
        for line in po_reader:
            ...
            if name == "applets/test_translation_import/static/src/xml/js_templates.xml":
