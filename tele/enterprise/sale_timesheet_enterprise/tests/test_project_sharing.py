...
from tele.applets.project.tests.test_project_sharing import TestProjectSharingCommon
from tele.applets.sale_timesheet_enterprise.models.sale import DEFAULT_INVOICED_TIMESHEET
