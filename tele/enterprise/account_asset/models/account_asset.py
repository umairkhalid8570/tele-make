...
from tele.tools import float_compare, float_is_zero, float_round
...
class AccountAsset(models.Model):
    ...
    depreciation_number_import = fields.Integer(help="In case of an import from another software, provide the number of depreciations already done before starting with Tele.", default=0)
