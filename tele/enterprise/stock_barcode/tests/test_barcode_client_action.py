...
import tele
from tele.tests import Form, HttpCase, tagged
...
class TestPickingBarcodeClientAction(TestBarcodeClientAction):
    def test_internal_picking_from_scratch_1(self):
        ...
        picking_write_orig = tele.applets.stock.models.stock_picking.Picking.write
        ...
        with patch('tele.applets.stock.models.stock_picking.Picking.write', new=picking_write_mock):
