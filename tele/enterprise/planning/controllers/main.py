...
# -*- coding: utf-8 -*-
# Part of Tele. See LICENSE file for full copyright and licens
...
class ShiftController(http.Controller):
    ...
    def _format_planning_shifts(color_code):
        """Take a color code from Tele's Kanban view and returns an hex code compatible with the fullcalendar library"""
