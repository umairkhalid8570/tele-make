tele.define('documents_account.tour', function(require) {
"use strict";
...
tour.register('documents_account_tour', {
    ...
    content: Markup(_t("Want to become a <b>paperless company</b>? Let's discover Tele-Documents.")),
    position: 'bottom',
}, {
    trigger: 'img[src="https://asset.cloudinary.com/tcms-cloud/54de559aeb97205df1ef9cfe8983424b"]',
