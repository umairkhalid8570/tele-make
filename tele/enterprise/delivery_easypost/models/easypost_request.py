...
from tele.tools.float_utils import float_round, float_is_zero, float_repr
...
class EasypostRequest():
    ...
    def rate_request(self, carrier, recipient, shipper, order=False, picking=False, is_return=False):
        ...
        # reference field to track Tele customers that use easypost for postage/shipping.
        order_payload['order[reference]'] = 'tele'
