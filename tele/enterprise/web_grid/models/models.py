...
from tele import _, api, models
from tele.exceptions import UserError
from tele.osv import expression
from tele.tools.misc import format_date, get_lang
...
class Base(models.AbstractModel):
    ...
    def _get_date_column_label(self, date, field, span, step):
        """
            ...
            :param field: tele.field object of the current model
        """
        ...
        if step == 'week':
            ...
            def _week_format(date):
                if field.type == 'date':
                    ...
                    # Check https://github.com/python-babel/babel/issues/619 and change this when Tele will use a fixed Babel version
    ...
    def _grid_range_of(self, span, step, anchor, field):
        """
            ...
            :param field: `tele.field` used as grouping criteria
        """
        if field.type == 'datetime':
