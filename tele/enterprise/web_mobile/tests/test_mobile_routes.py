...
from tele.tools import config, mute_logger
...
class MobileRoutesTest(HttpCase):
    ...
    def test_version_info(self):
        """
        This request is used to check for a compatible Tele server
        """
    ...
    def test_database_list(self):
        ...
        if config['list_db']:
            ...
            self.assertEqual(error["message"], "Tele Server Error")
            self.assertEqual(error["data"]["name"], "tele.exceptions.AccessDenied")
