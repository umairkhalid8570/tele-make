tele.define('timesheet_grid.TimesheetConfigQRCodeMixin', function (require) {
    "use strict";
    ...
    const TimesheetConfigQRCodeMixin = {
        ...
        _onClickAppStoreIcon(ev) {
            ev.preventDefault();
            const googleUrl = "https://play.google.com/store/apps/details?id=com.tele.TeleTimesheets";
