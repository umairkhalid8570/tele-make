...
from tele.applets.test_mail.tests import common as test_mail_common
...
class TestMailMobile(test_mail_common.TestMailCommon):
    ...
    def setUpClass(cls):
        ...
        cls.env['ir.config_parameter'].sudo().set_param('web.base.url', 'http://yourcompany.tele.studio')
    ...
    def test_override_url_in_mail(self):
        ...
        original_expected_link = 'http://yourcompany.tele.studio/mail/view?model=mail.activity&res_id=1'
