tele.define('tele_studio.ActionEditor', function (require) {
"use strict";

var Widget = require('web.Widget');

var ActionEditorSidebar = require('tele_studio.ActionEditorSidebar');
var ActionEditorView = require('tele_studio.ActionEditorView');

const { SUPPORTED_VIEW_TYPES } = require("@tele_studio/studio_service");

var ActionEditor = Widget.extend({
    template: 'tele_studio.ActionEditor',
    custom_events: {
    ...
    start: function () {
        ...
        _.each(ordered_view_types, function (view_type) {
            ...
            if (category) {
                view.appendTo(
                    self.$('.o_tele_studio_view_category[name=' + category + ']')
                );
            }
        });
