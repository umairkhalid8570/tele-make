tele.define('tele_studio.SearchRenderer', function (require) {
"use strict";
...
var SearchRenderer = Widget.extend({
    ...
    _render: function () {
        ...
        this.defs = [];
        this.$el.empty();
        this.$el.html(qweb.render('tele_studio.searchRenderer', this.widget));
    ...
    _renderFilter: function (node) {
        var $tbody = this.$('.o_tele_studio_search_filters tbody');
    ...
    _renderGroupBy: function (node) {
        var $tbody = this.$('.o_tele_studio_search_group_by tbody');
    ...
    _renderSeparator: function () {
        var $tbody = this.$('.o_tele_studio_search_filters tbody');
        var $new_row = $('<tr class="o_tele_studio_separator">').html('<td><hr/></td>');
