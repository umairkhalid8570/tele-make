tele.define('tele_studio.reportNewComponents', function (require) {
"use strict";
...
var BlockText = AbstractNewBuildingBlock.extend({
    ...
    hookClass: 'o_tele_studio_block_char',
    add: function () {
        var self = this;
...
var InlineText = AbstractNewBuildingBlock.extend({
    ...
    label: _lt('Text'),
    className: 'o_tele_studio_field_char',
    hookClass: 'o_tele_studio_hook_inline',
    hookAutoHeight: true,
...
var ColumnHalfText = AbstractNewBuildingBlock.extend({
    ...
    dropIn: '.page',
    className: 'o_tele_studio_field_fa',
    fa: 'fa-align-left',
    hookClass: 'o_tele_studio_block_char',
    hookTag: 'div',
    dropColumns: [[0, 6], [0, 6]],
...
var BlockField = AbstractFieldBlock.extend({
    ...
    hookClass: 'o_tele_studio_hook_field',
    dropIn: '.page',
...
var TableColumnField = AbstractFieldBlock.extend({
    ...
    fa: ' fa-plus-square',
    hookAutoHeight: true,
    hookClass: 'o_tele_studio_hook_table_column',
    dropIn: 'tr',
    _dataInheritance: function (values) {
        var $field = $('<span/>').attr('t-field', values.related);
        if (values.type === 'binary') {
...
var LabelledField = AbstractFieldBlock.extend({
    ...
    className: 'o_tele_studio_field_many2one',
    hookClass: 'o_tele_studio_hook_information',
...
var Image = AbstractNewBuildingBlock.extend({
    ...
    hookClass: 'o_tele_studio_hook_picture',
    add: function () {
        var self = this;
        return this._super.apply(this, arguments).then(function () {
...
var BlockTitle = AbstractNewBuildingBlock.extend({
    ...
    className: 'o_tele_studio_field_char',
    hookClass: 'o_tele_studio_hook_title',
    dropIn: '.page',
    add: function () {
        var self = this;
        return this._super.apply(this, arguments).then(function () {
...
var BlockAddress = AbstractNewBuildingBlock.extend({
    ...
    className: 'o_tele_studio_field_fa',
    hookAutoHeight: false,
    hookClass: 'o_tele_studio_hook_address',
...
var BlockTable = AbstractNewBuildingBlock.extend({
    ...
    fa: 'fa-th-list',
    className: 'o_tele_studio_field_fa',
    hookClass: 'o_tele_studio_hook_table',
    dropIn: '.page',
    add: function () {
        var self = this;
        var callersArguments = arguments;
...
var TableBlockTotal = AbstractNewBuildingBlock.extend({
    ...
    className: 'o_tele_studio_field_fa',
    dropIn: '.page',
    hookClass: 'o_tele_studio_hook_total',
    dropColumns: [[0, 5], [2, 5]],
    add: function () {
        var self = this;
        var callersArguments = arguments;
