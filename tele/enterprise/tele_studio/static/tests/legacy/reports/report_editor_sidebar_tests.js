tele.define('tele_studio.ReportEditorSidebar_tests', function (require) {
"use strict";
...
QUnit.module('Studio', {}, function () {
    ...
    QUnit.module('ReportEditorSidebar', {
        ...
        QUnit.test("basic rendering", async function (assert) {
            ...
            assert.hasClass(sidebar.$('.o_tele_studio_sidebar_header [name="report"]'),'active',
                "the report tab should be active");
            assert.hasClass(sidebar.$('.o_tele_studio_sidebar_header [name="options"]'),'inactive',
            ...
            testUtils.dom.click(sidebar.$('.o_tele_studio_sidebar_header [name="new"]'));
            assert.verifySteps(['new'], "the sidebar should be updated");

            await testUtils.dom.click(sidebar.$('.o_tele_studio_sidebar_header [name="options"]'));
        ...
        QUnit.test("'Report' tab behaviour", async function (assert) {
            ...
            assert.hasAttrValue(sidebar.$('.o_tele_studio_sidebar_header > .active'), 'name', "report",
                "the 'Report' tab should be active");
        ...
        QUnit.test("'Add' tab behaviour", function (assert) {
            ...
            assert.hasAttrValue(sidebar.$('.o_tele_studio_sidebar_header > .active'), 'name', "new",
        ...
        QUnit.test("basic 'Options' tab behaviour", function (assert) {
            ...
            assert.hasAttrValue(sidebar.$('.o_tele_studio_sidebar_header > .active'), 'name', "options",
                "the 'Options' tab should be active");
            assert.containsOnce(sidebar, '.o_tele_studio_sidebar_content .collapse',
                "there should be one node in the accordion");
            assert.hasClass(sidebar.$('.o_tele_studio_sidebar_content .collapse'),'show',
            ...
            testUtils.dom.click(sidebar.$('.o_tele_studio_sidebar_content .collapse .o_tele_studio_remove'));
        ...
        QUnit.test("'Options' tab with multiple nodes", function (assert) {
            ...
            assert.hasAttrValue(sidebar.$('.o_tele_studio_sidebar_header > .active'), 'name', "options",
                "the 'Options' tab should be active");
            assert.containsN(sidebar, '.o_tele_studio_sidebar_content .card', 2,
                "there should be one node in the accordion");
            assert.hasClass(sidebar.$('.o_tele_studio_sidebar_content .card:has(.o_text:contains(span)) .collapse'),'show',
                "the 'span' node should be expanded by default");
            assert.doesNotHaveClass(sidebar.$('.o_tele_studio_sidebar_content .card:has(.o_text:contains(div)) .collapse'), 'show',
                "the 'div' node shouldn't be expanded");
            assert.strictEqual(sidebar.$('.o_tele_studio_sidebar_content .o_tele_studio_accordion > .card:last .card-header:first').text().trim(), "span",
                "the last node should be the span");

            // expand the first node
            testUtils.dom.click(sidebar.$('.o_tele_studio_sidebar_content .o_tele_studio_accordion > .card:first [data-toggle="collapse"]:first'));
            // BS4 collapsing is asynchronous
            setTimeout(function () {
                assert.doesNotHaveClass(sidebar.$('.o_tele_studio_sidebar_content .card:has(.o_text:contains(span)) .collapse:first'), 'show',
                    "the 'span' node should have been closed");
                assert.hasClass(sidebar.$('.o_tele_studio_sidebar_content .card:has(.o_text:contains(div)) .collapse:first'),'show',
                    "the 'div' node should be expanded");

                // reexpand the second node
                testUtils.dom.click(sidebar.$('.o_tele_studio_sidebar_content .o_tele_studio_accordion > .card:last [data-toggle="collapse"]:first'));
                setTimeout(function () {
                    assert.hasClass(sidebar.$('.o_tele_studio_sidebar_content .card:has(.o_text:contains(span)) .collapse:first'),'show',
                        "the 'span' node should be expanded again");
                    assert.doesNotHaveClass(sidebar.$('.o_tele_studio_sidebar_content .card:has(.o_text:contains(div)) .collapse:first'), 'show',
        ...
        QUnit.test("'Options' tab with layout component can be expanded", function (assert) {
            ...
            assert.containsOnce(sidebar, '.o_tele_studio_sidebar_content .collapse',
                "there should be one node in the accordion");
            assert.containsOnce(sidebar, '.o_tele_studio_sidebar_content .o_tele_studio_layout',
                "there should be a layout component");
            assert.containsOnce(sidebar, '.o_tele_studio_sidebar_content .o_tele_studio_layout .o_tele_studio_margin',
        ...
        QUnit.test("'Options' tab with layout component can be expanded on open ", function (assert) {
            ...
            assert.equal(sidebar.$('.o_tele_studio_width:visible').length, 1);
        ...
        QUnit.test("'Options' tab with widget selection (tOptions) component", function (assert) {
            ...
            assert.containsOnce(sidebar, '.o_tele_studio_tfield_fieldexpression',
                "the t-field component should be displayed");
            assert.containsOnce(sidebar, '.o_tele_studio_toption_widget',
                "the t-options component should be displayed");
            assert.strictEqual(sidebar.$('.o_tele_studio_toption_widget select').text().replace(/\s/g, ''), "imageintegertext",
                "all widgets should be selectable");
            assert.strictEqual(sidebar.$('.o_tele_studio_toption_widget select').val(), "text",
        ...
        QUnit.test("'Options' tab with FieldSelector does not flicker", async function (assert) {
            ...
            await testUtils.nextTick();
            assert.strictEqual($('.o_tele_studio_tfield_fieldexpression').length, 0,
            ...
            await testUtils.nextTick();
            assert.strictEqual($('.o_tele_studio_tfield_fieldexpression').length, 1,
                "the t-field component should be displayed");
            assert.strictEqual(sidebar.$('.o_tele_studio_tfield_fieldexpression .o_field_selector_value').text().replace(/\s/g, ''),
                "doc(MyModel)ID",
        ...
        QUnit.test('Various layout changes', function (assert) {
            ...
            var layoutChangesOperations = [
                ...
                sidebarOperationInputSelector: '.o_tele_studio_margin [data-margin="margin-top"]',
                valueToPut: "42",
                expectedRPC: {
                    inheritance: [{
                    ...
                    nodeToUse: layoutChangeNode,
                    eventToTrigger: "change",
                    sidebarOperationInputSelector: '.o_tele_studio_margin [data-margin="margin-bottom"]',
                    valueToPut: "42",
                    expectedRPC: {
                        inheritance: [{
                    ...
                    nodeToUse: layoutChangeNode,
                    eventToTrigger: "change",
                    sidebarOperationInputSelector: '.o_tele_studio_margin [data-margin="margin-left"]',
                    valueToPut: "42",
                    expectedRPC: {
                        inheritance: [{
                    ...
                    nodeToUse: layoutChangeNode,
                    eventToTrigger: "change",
                    sidebarOperationInputSelector: '.o_tele_studio_margin [data-margin="margin-right"]',
                    valueToPut: "42",
                    expectedRPC: {
                        inheritance: [{
                    ...
                    nodeToUse: layoutChangeNode,
                    eventToTrigger: "change",
                    sidebarOperationInputSelector: '.o_tele_studio_width input',
                    valueToPut: "42",
                    expectedRPC: {
                        inheritance: [{
                    ...
                    nodeToUse: layoutChangeNode,
                    eventToTrigger: "change",
                    sidebarOperationInputSelector: '.o_tele_studio_classes input',
                    ...
                    sidebarOperationInputSelector: '.o_tele_studio_font_size .dropdown-item-text[data-value="h3"]',
                    expectedRPC: {
                        inheritance: [{
                    ...
                    sidebarOperationInputSelector: '.o_tele_studio_colors .o_tele_studio_background_colorpicker button[data-color="o-color-3"]',
                    expectedRPC: {
                        inheritance: [{
                    ...
                    nodeToUse: layoutChangeNode,
                    eventToTrigger: "mousedown",
                    sidebarOperationInputSelector: '.o_tele_studio_colors .o_tele_studio_background_colorpicker button[data-value="#00FF00"]',
                    valueToPut: "h3",
                    expectedRPC: {
                        inheritance: [{
                    ...
                    nodeToUse: layoutChangeNode,
                    eventToTrigger: "mousedown",
                    sidebarOperationInputSelector: '.o_tele_studio_colors .o_tele_studio_font_colorpicker button[data-color="o-color-3"]',
                    expectedRPC: {
                        inheritance: [{
                    ...
                    nodeToUse: layoutChangeNode,
                    eventToTrigger: "mousedown",
                    sidebarOperationInputSelector: '.o_tele_studio_colors .o_tele_studio_font_colorpicker button[data-value="#00FF00"]',
                    valueToPut: "h3",
                    expectedRPC: {
                        inheritance: [{
                    ...
                    nodeToUse: layoutChangeNode,
                    eventToTrigger: "click",
                    sidebarOperationInputSelector: '.o_tele_studio_text_alignment button[title="right"]',
                    expectedRPC: {
                        inheritance: [{
                ...
                expectedRPC: {
                    ...
                    nodeToUse: nodeWithAllLayoutPropertiesSet,
                    eventToTrigger: "click",
                    sidebarOperationInputSelector: '.o_tele_studio_colors .o_tele_studio_background_colorpicker .o_tele_studio_reset_color',
                    expectedRPC: {
                        inheritance: [{
                    ...
                    nodeToUse: nodeWithAllLayoutPropertiesSet,
                    eventToTrigger: "click",
                    sidebarOperationInputSelector: '.o_tele_studio_colors .o_tele_studio_font_colorpicker .o_tele_studio_reset_color',
                    expectedRPC: {
                        inheritance: [{
                    ...
                    nodeToUse: nodeWithAllLayoutPropertiesFontAndBackgroundSet,
                    eventToTrigger: "click",
                    sidebarOperationInputSelector: '.o_tele_studio_colors .o_tele_studio_font_colorpicker button.o_tele_studio_reset_color',
                    expectedRPC: {
                        inheritance: [{
