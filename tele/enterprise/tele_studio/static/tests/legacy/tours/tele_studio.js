tele.define('tele_studio.tests.tour', function (require) {
"use strict";

const localStorage = require('web.local_storage');
const tour = require('web_tour.tour');

const { randomString } = require('tele_studio.utils');

let createdAppString = null;
let createdMenuString = null;

tour.register('tele_studio_tests_tour', {
    url: "/web",
    test: true,
}, [{
    // open studio
    trigger: '.o_main_navbar .o_tele_studio_navbar_item',
}, {
    trigger: '.o_tele_studio_new_app',
}, {
    // the next steps are here to create a new app
    trigger: '.o_tele_studio_app_creator_next',
}, {
    trigger: '.o_tele_studio_app_creator_name > input',
    run: 'text ' + (createdAppString = randomString(6)),
}, {
    trigger: '.o_tele_studio_app_creator_next.is_ready',
}, {
    trigger: '.o_tele_studio_app_creator_menu > input',
    ...
    extra_trigger: '.o_tele_studio_app_creator',
    trigger: '.o_tele_studio_leave > a.btn',
}, {
    ...
    run: function () {
        ...
        const editIcon = this.$anchor[0].querySelector('.o_tele_studio_edit_icon');
    ...
    trigger: '.o_tele_studio_selector:eq(0)',
}, {
    trigger: '.o_tele_studio_palette > .o_tele_studio_selector:first',
}, {
    ...
    extra_trigger: '.o_tele_studio_menu',
    // switch to form view
    trigger: '.o_tele_studio_views_icons > a[title="Form"]',
}, {
    // wait for the form editor to be rendered because the sidebar is the same
    extra_trigger: '.o_tele_studio_form_view_editor',
    // unfold 'Existing Fieldqs' section
    trigger: '.o_tele_studio_existing_fields_header',
}, {
    // add an new field
    trigger: '.o_tele_studio_sidebar .o_tele_studio_field_type_container:eq(1) .o_tele_studio_field_char',
    run: 'drag_and_drop .o_tele_studio_form_view_editor .o_inner_group',
}, {
    // click on the field
    trigger: '.o_tele_studio_form_view_editor td.o_td_label:first',
    // when it's there
    extra_trigger: 'input[data-type="field_name"]',
}, {
    // rename the label
    trigger: '.o_tele_studio_sidebar_content.o_display_field input[name="string"]',
    ...
    run: 'text coucou',
    // the rename operation (/tele_studio/rename_field + /tele_studio/edit_view)
    // takes a while and sometimes reaches the default 10s timeout
    timeout: 20000,
}, {
    // click on "Add" tab
    trigger: '.o_tele_studio_sidebar .o_tele_studio_new',
    // the rename operation (/tele_studio/rename_field + /tele_studio/edit_view)
    // takes a while and sometimes reaches the default 10s timeout
    timeout: 20000,
    async run() {
    ...
    trigger: '.o_tele_studio_sidebar .o_tele_studio_field_type_container:eq(1) .o_tele_studio_field_monetary',
    run: 'drag_and_drop .o_tele_studio_form_view_editor .o_inner_group',
}, {
    trigger: '.modal-footer .btn.btn-primary',
}, {
    // verify that the currency field is in the view
    extra_trigger: '.o_tele_studio_form_view_editor td.o_td_label:contains("Currency")',
    trigger: '.o_tele_studio_sidebar .o_tele_studio_new',
    async run() {
    ...
    trigger: '.o_tele_studio_sidebar .o_tele_studio_field_type_container:eq(1) .o_tele_studio_field_monetary',
    run: 'drag_and_drop (.o_tele_studio_form_view_editor .o_inner_group:first .o_tele_studio_hook:eq(1))',
}, {
    // verify that the monetary field is in the view
    extra_trigger: '.o_tele_studio_form_view_editor td.o_td_label:eq(1):contains("New Monetary")',
    // switch the two first fields
    trigger: '.o_tele_studio_form_view_editor .o_inner_group:first .ui-draggable:eq(1)',
    run: 'drag_and_drop .o_inner_group:first .o_tele_studio_hook:first',
}, {
    // click on "Add" tab
    trigger: '.o_tele_studio_sidebar .o_tele_studio_new',
}, {
    // verify that the fields have been switched
    extra_trigger: '.o_tele_studio_form_view_editor td.o_td_label:eq(0):contains("New Monetary")',
    // add a m2m field
    trigger: '.o_tele_studio_sidebar .o_tele_studio_field_type_container:eq(1) .o_tele_studio_field_many2many',
    run: 'drag_and_drop .o_inner_group:first .o_tele_studio_hook:first',
}, {
    ...
    trigger: '.o_tele_studio_sidebar select[name="widget"]',
    run: function () {
        this.$anchor.val('many2many_tags').trigger('change');
    },
}, {
    // use colors on the m2m tags
    trigger: '.o_tele_studio_sidebar label[for="option_color_field"]',
}, {
    // add a statusbar
    trigger: '.o_tele_studio_statusbar_hook',
}, {
    trigger: '.modal-footer .btn.btn-primary',
}, {
    ...
    trigger: '.o_tele_studio_sidebar select[name="default_value"]:contains(First Status)',
}, {
    trigger: '.o_tele_studio_views_icons a[title=Form]',
}, {
    // verify Chatter can be added after changing view to form
    extra_trigger: '.o_tele_studio_add_chatter',
    // edit action
    trigger: '.o_tele_studio_menu .o_menu_sections li a:contains(Views)',
}, {
    // edit form view
    trigger: '.o_tele_studio_view_category .o_tele_studio_view_type[data-type="form"] .o_tele_studio_thumbnail',
}, {
    // verify Chatter can be added after changing view to form
    extra_trigger: '.o_tele_studio_add_chatter',
    // switch in list view
    trigger: '.o_tele_studio_menu .o_tele_studio_views_icons a[title="List"]',
}, {
    // wait for the list editor to be rendered because the sidebar is the same
    extra_trigger: '.o_tele_studio_list_view_editor',
    // unfold 'Existing Fieldqs' section
    trigger: '.o_tele_studio_existing_fields_header',
}, {
    // add an existing field (display_name)
    trigger: '.o_tele_studio_sidebar .o_tele_studio_field_type_container:eq(1) .o_tele_studio_field_char',
    run: 'drag_and_drop .o_tele_studio_list_view_editor th.o_tele_studio_hook:first',
}, {
    // verify that the field is correctly named
    extra_trigger: '.o_tele_studio_list_view_editor th:contains("COUCOU")',
    // leave Studio
    trigger: '.o_tele_studio_leave > a.btn',
}, {
    ...
    // re-open studio
    trigger: '.o_tele_studio_navbar_item',
}, {
    // modify the list view
    trigger: '.o_tele_studio_sidebar .o_tele_studio_view'
}, {
    //select field you want to sort and based on that sorting will be applied on List view
    trigger: '.o_tele_studio_sidebar .o_tele_studio_sidebar_select #sort_field',
    run: function () {
    ...
    trigger: '.o_tele_studio_sidebar .o_tele_studio_sidebar_select #sort_order',
    run: function () {
    ...
    // add a kanban
    trigger: '.o_tele_studio_view_category .o_tele_studio_view_type.o_tele_studio_inactive[data-type="kanban"] .o_tele_studio_thumbnail',
}, {
    // add a dropdown
    trigger: '.o_dropdown_kanban.o_tele_studio_add_dropdown',
}, {
    trigger: '.modal-footer .btn.btn-primary',
}, {
    // select the dropdown for edition
    trigger: '.o_dropdown_kanban:not(.o_tele_studio_add_dropdown)',
}, {
    // enable "Set Cover" feature
    trigger: '.o_tele_studio_sidebar input[name=set_cover]',
}, {
    trigger: '.modal-footer .btn.btn-primary',
}, {
    // edit action
    ...
    extra_trigger: '.o_tele_studio_view_category .o_tele_studio_view_type:not(.o_tele_studio_inactive)[data-type="kanban"]',
    // add an activity view
    trigger: '.o_tele_studio_view_category .o_tele_studio_view_type.o_tele_studio_inactive[data-type="activity"] .o_tele_studio_thumbnail',
}, {
    ...
    // add a graph view
    trigger: '.o_tele_studio_view_category .o_tele_studio_view_type.o_tele_studio_inactive[data-type="graph"] .o_tele_studio_thumbnail',
}, {
    extra_trigger: '.o_legacy_graph_renderer',
    trigger: '.o_tele_studio_menu .o_menu_sections li a:contains("Views")',
}, {
    extra_trigger: '.o_tele_studio_views',
    // edit the search view
    trigger: '.o_tele_studio_view_category .o_tele_studio_view_type[data-type="search"] .o_tele_studio_thumbnail',
}, {
    extra_trigger: '.o_tele_studio_search_view_editor',
    trigger: '.o_menu_toggle.fa-th',
}, {
    trigger: '.o_tele_studio_home_studio_menu .dropdown-toggle',
}, {
    // export all modifications
    trigger: '.o_tele_studio_export',
}, {
    // click on the created app
    ...
    trigger: '.o_tele_studio_view',
}, {
    // click on the restore default view button
    trigger: '.o_tele_studio_restore',
}, {
...
tour.register('tele_studio_hide_fields_tour', {
    ...
    trigger: `
        .o_tele_studio_app_creator_name
        > input`,
    ...
    trigger: `
        ...
        .o_tele_studio_selector:eq(2)`,
}, {
    trigger: '.o_tele_studio_app_creator_next',
}, {
    trigger: `
        .o_tele_studio_app_creator_menu
        > input`,
    run: `text ${randomString(6)}`,
}, {
    trigger: '.o_tele_studio_app_creator_next',
    ...
    extra_trigger: '.o_tele_studio_menu',
    trigger: `
        .o_tele_studio_views_icons
        > a[title="List"]`,
}, {
    // wait for the list editor to be rendered because the sidebar is the same
    extra_trigger: '.o_tele_studio_list_view_editor',
    trigger: '.o_tele_studio_existing_fields_icon',
}, {
    trigger: `
        .o_tele_studio_sidebar
        .o_tele_studio_existing_fields
        .o_tele_studio_component:has(.o_tele_studio_component_description:contains(display_name))`,
    run: 'drag_and_drop .o_tele_studio_list_view_editor .o_tele_studio_hook',
}, {
    trigger: `
        .o_list_table
    ...
    extra_trigger: `
        .o_list_table
        th[data-name="display_name"].o_tele_studio_show_invisible`,
    trigger: '.o_tele_studio_leave > a.btn',
}]);

tour.register('tele_studio_model_option_value_tour', {
    ...
    trigger: '.o_tele_studio_menu .o_tele_studio_views_icons > a[title="Graph"]',
    timeout: 60000, /* previous step reloads registry, etc. - could take a long time */
}, {
    ...
    trigger: '.o_tele_studio_menu .o_tele_studio_views_icons a[title="Pivot"]',
}, {
...
tour.register('tele_studio_new_report_tour', {
    url: "/web",
    test: true,
}, [{
    // open studio
    ...
    // edit reports
    trigger: '.o_tele_studio_menu li a:contains(Reports)',
}, {
    // create a new report
    trigger: '.o_control_panel .o-kanban-button-new',
}, {
    // select external layout
    trigger: '.o_tele_studio_report_layout_dialog div[data-layout="web.external_layout"]',
}, {
    // sidebar should display add tab
    extra_trigger: '.o_tele_studio_report_editor_manager .o_tele_studio_sidebar_header div.active[name="new"]',
    // switch to 'Report' tab
    trigger: '.o_tele_studio_report_editor_manager .o_tele_studio_sidebar_header div[name="report"]',
}, {
    // edit report name
    trigger: '.o_tele_studio_sidebar input[name="name"]',
    run: 'text My Awesome Report',
}, {
    // switch to 'Add' in Sidebar
    trigger: '.o_tele_studio_sidebar div[name="new"]',
}, {
    // wait for the iframe to be loaded
    extra_trigger: '.o_tele_studio_report_editor iframe #wrapwrap',
    // add a 'title' building block
    trigger: '.o_tele_studio_sidebar .o_tele_studio_component:contains(Title Block)',
    run: 'drag_and_drop .o_tele_studio_report_editor iframe .article > .page',
    auto: true,
}, {
    // click on the newly added field
    trigger: '.o_tele_studio_report_editor iframe .h2 > span:contains(New Title)',
}, {
    // change the text of the H2 to 'test'
    trigger: '.o_tele_studio_sidebar .o_tele_studio_text .note-editable',
    run: function () {
        this.$anchor.focusIn();
    ...
    trigger: '.o_tele_studio_report_editor',
    extra_trigger: '.o_tele_studio_sidebar .o_tele_studio_text .note-editable:contains(Test)',
}, {
    extra_trigger: '.o_tele_studio_report_editor iframe .h2:contains(Test)',
    // add a new group on the node
    trigger: '.o_tele_studio_sidebar .o_field_many2manytags[name="groups"] input',
    run: function () {
        this.$anchor.click();
    },
}, {
    ...
    extra_trigger: '.o_tele_studio_sidebar .o_field_many2manytags[name="groups"] .o_badge_text:contains(Access Rights)',
    // switch to 'Add' in Sidebar
    trigger: '.o_tele_studio_sidebar div[name="new"]',
}, {
    // add a 'title' building block Data Table
    trigger: '.o_tele_studio_sidebar .o_tele_studio_component:contains(Data table)',
    run: 'drag_and_drop .o_tele_studio_report_editor iframe .article > .page',
}, {
    ...
    trigger: '.o_tele_studio_report_editor iframe span[t-field="table_line.display_name"]'
}, {
    // change the bound field
    trigger: '.o_tele_studio_sidebar .card:last() div.o_field_selector_value',
    run: function () {
        $('.o_tele_studio_sidebar .card:last() div.o_field_selector_value').focusin();
    }
}, {
    trigger: 'ul.o_field_selector_page li:contains(ID)'
}, {
    // update the title of the column
    extra_trigger: '.o_tele_studio_report_editor iframe span[t-field="table_line.id"]',
    trigger: '.o_tele_studio_report_editor iframe table thead span:contains(Name) ', // the name title
    //extra_trigger: '.o_tele_studio_report_editor iframe span[t-field="table_line.display_name"]:not(:contains(YourCompany, Administrator))', // the id has been updated in the iframe
}, {
    ...
    // click outside to blur the field
    trigger: '.o_tele_studio_report_editor',
    extra_trigger: '.o_tele_studio_sidebar .o_tele_studio_text .note-editable:contains(new column title)',
}, {
    // wait to be sure the modification has been correctly applied
    extra_trigger: '.o_tele_studio_report_editor iframe table thead span:contains(new column title) ',
    // leave the report
    trigger: '.o_tele_studio_breadcrumb .o_back_button:contains(Reports)',
}, {
    ...
    extra_trigger: '.o_tele_studio_sidebar input[name="name"][value="My Awesome Report copy(1)"]',
    // leave Studio
    trigger: '.o_tele_studio_leave > a.btn',
}]);

tour.register('tele_studio_new_report_basic_layout_tour', {
    url: "/web",
    test: true,
}, [{
    // open studio
    ...
    // select external layout
    trigger: '.o_tele_studio_report_layout_dialog div[data-layout="web.basic_layout"]',
}, {
    // sidebar should display add tab
    extra_trigger: '.o_tele_studio_report_editor_manager .o_tele_studio_sidebar_header div.active[name="new"]',
    // switch to 'Report' tab
    ...
    // wait for the duplicated report to be correctly loaded
    extra_trigger: '.o_tele_studio_sidebar input[name="name"][value="My Awesome basic layout Report copy(1)"]',
    // leave Studio
    trigger: '.o_tele_studio_leave > a.btn',
}]);

tour.register('tele_studio_approval_tour', {
    url: "/web",
    test: true,
}, [{
    // go to Apps menu
    ...
    trigger: '.o_tele_studio_form_view_editor button[data-node-id]',
}, {
    // enable approvals for the button
    trigger: '.o_tele_studio_sidebar label[for="studio_approval"]',
}, {
    // set approval message
    trigger: '.o_tele_studio_sidebar_approval input[name*="approval_message"]',
    run: 'text nope',
}, {
    // add approval rule
    trigger: '.o_tele_studio_sidebar_approval .o_approval_new',
    extra_trigger: '.o_tele_studio_snackbar .fa-check',
}, {
    // set domain on first rule
    trigger: '.o_tele_studio_sidebar_approval .o_approval_domain',
    ...
    trigger: '.o_tele_studio_sidebar label[for*="exclusive_user"]',
    extra_trigger: '.o_tele_studio_snackbar .fa-check',
}, {
    // leave studio
    trigger: '.o_tele_studio_leave > a.btn',
...
tour.register('tele_studio_custom_field_tour', {
    url: "/web",
    test: true,
}, [{
    // go to Apps menu
...
tour.register('tele_studio_local_storage_tour', {
    url: "/web",
    test: true,
}, [{
    trigger: '.o_app[data-menu-xmlid="base.menu_management"]',
...
tour.register('tele_studio_custom_background_tour', {
    url: "/web",
    test: true,
}, [{
    ...
    trigger: '.o_tele_studio_home_studio_menu button',
}, {
    content: 'reset the background',
    trigger: '.o_tele_studio_reset_default_background',
}, {
