...
from tele.applets.project_enterprise_hr.tests.auto_shift_dates_hr_common import AutoShiftDatesHRCommon
from tele.applets.project_enterprise.tests.auto_shift_dates_common import fake_now
