...
from tele.applets.sale_amazon.tests.common import TestAmazonCommon, BASE_ORDER_DATA, BASE_ITEM_DATA
...
class TestAmazon(TestAmazonCommon):
    ...
    def test_check_credentials_succeed(self):
        ...
        with patch(
                'tele.applets.sale_amazon.models.mws_connector.do_account_credentials_check',
    ...
    def test_update_marketplaces_no_change(self):
        ...
        with patch(
                'tele.applets.sale_amazon.models.amazon_account.AmazonAccount'
    ...
    @mute_logger('tele.applets.sale_amazon.models.amazon_account')
    def test_sync_orders_full(self):
        ...
        with patch('tele.applets.sale_amazon.models.mws_connector.get_api_connector',
                   new=lambda *args, **kwargs: None), \
             patch('tele.applets.sale_amazon.models.mws_connector.get_orders_data',
                   new=_get_orders_data_mock), \
             patch('tele.applets.sale_amazon.models.mws_connector.get_items_data',
                   new=_get_items_data_mock), \
             patch('tele.applets.sale_amazon.models.amazon_account.AmazonAccount._get_product',
    ...
    def test_sync_orders_europe(self):
        ...
        with patch('tele.applets.sale_amazon.models.mws_connector.get_api_connector',
             ...
             patch('tele.applets.sale_amazon.models.mws_connector.get_items_data',
                   new=_get_items_data_mock), \
             patch('tele.applets.sale_amazon.models.amazon_account.AmazonAccount._recompute_subtotal',
    ...
    @mute_logger('tele.applets.sale_amazon.models.stock_picking')
    def test_sync_orders_cancel_abort(self):
        """ Test the pickings that were confirmed at tele and then order is canceled at amazon. """
        ...
        with patch('tele.applets.sale_amazon.models.mws_connector.get_api_connector',
             ...
             patch('tele.applets.sale_amazon.models.mws_connector.get_items_data',
                   new=_get_items_data_mock), \
             patch('tele.applets.sale_amazon.models.mws_connector.submit_feed',
    ...
    def test_get_partners_creation_contact(self):
        ...
        self.assertEqual(contact.city, 'TeleCity')
