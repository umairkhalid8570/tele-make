...
from tele import api, Command, fields, models, tools, _
...
class HelpdeskTicket(models.Model):
    ...
    def _compute_open_hours(self):
        for ticket in self:
            if ticket.create_date:  # fix from https://github.com/tele-studio/enterprise/commit/928fbd1a16e9837190e9c172fa50828fae2a44f7
