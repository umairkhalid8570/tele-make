...
var BackArrow = FieldInteger.extend({
    ...
    _render: function () {
        this.$el.html('<button class="btn btn-secondary rounded-sm o_workorder_icon_btn o_workorder_icon_back"><i class="fa fa-arrow-left"/></button>');
    },
    _onClick: function () {
        var self = this;
        this._rpc({
...
function tabletRenderButtons($node) {
        var self = this;
        this.$buttons = $('<div/>');
        this.$buttons.html('<button class="btn btn-secondary rounded-sm back-button"><i class="fa fa-arrow-left"/></button>');
