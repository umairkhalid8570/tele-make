...
class TestEbay(TransactionCase):
    ...
    def test_synchronize_order(self):
        ...
        with patch('tele.applets.sale_ebay.models.product.ProductTemplate.ebay_execute',
                   new=self.fake_execute_data(EBAY_ANSWER_1)), patch('tele.applets.sale_ebay.models.product.ProductTemplate._ebay_configured', new=lambda d: True):
            number_of_sos = []
            ...
            # it should create matching ones within Tele
