...
The eBay integrator gives you the opportunity to manage your Tele's products on eBay.
...
* Automatic creation of sales order and invoices
  ...
  # Check https://github.com/tele-studio/tele/blob/master/tele/applets/base/data/ir_module_category_data.xml
  # for the full list
