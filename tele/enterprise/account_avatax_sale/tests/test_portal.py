...
from tele.applets.account_avatax_sale.tests.test_avatax import TestAccountAvataxCommon
from tele.applets.base.tests.common import HttpCase
...
class TestAccountAvataxSalePortal(TestAccountAvataxCommon, HttpCase):
    ...
    def test_01_portal_test_optional_products(self):
        ...
        with self._capture_request({'lines': [], 'summary': []}), \
             patch('tele.applets.account_avatax_sale.models.sale_order.SaleOrder.button_update_avatax') as mocked_button_update_avatax:
