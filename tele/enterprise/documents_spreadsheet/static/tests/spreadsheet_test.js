/** @tele-module alias=documents_spreadsheet.SpreadsheetTests */
/* global $ */
...
module(
    ...
    function () {
        ...
        test("Can rebuild the Tele domain of records based on the according pivot cell", async function (assert) {
            assert.expect(1);
            const archs = {
                "partner,false,pivot": `
                    <pivot string="Partners">
        ...
        test("Can rebuild the Tele domain of records based on a cell containing the total of pivots cells (in a column)", async function (assert) {
            assert.expect(1);
            const archs = {
                "partner,false,pivot": `
                    <pivot string="Partners">
        ...
        test("Can rebuild the Tele domain of records based on a cell containing the total of pivots cells (in a row)", async function (assert) {
            assert.expect(4);
            const archs = {
                "partner,false,pivot": `
                    <pivot string="Partners">
        ...
        test("Can rebuild the Tele domain of records based on a total of all pivot cells", async function (assert) {
            assert.expect(1);
            const archs = {
                "partner,false,pivot": `
                    <pivot string="Partners">
        ...
        test("Can rebuild the Tele domain of records based on the according merged pivot cell", async function (assert) {
            assert.expect(1);
            const archs = {
                "partner,false,pivot": `
                    <pivot string="Partners">
