...
from tele.applets.account_consolidation.report.handler.abstract import AbstractHandler
from tele.applets.account_consolidation.report.handler.journals import JournalsHandler
from tele.applets.account_consolidation.report.handler.periods import PeriodsHandler
from tele.applets.account_consolidation.report.handler.show_zero import ShowZeroHandler
...
class TestAbstractHandler(TransactionCase):
    ...
    @patch('tele.applets.account_consolidation.report.handler.abstract.AbstractHandler.get_selected_values')
...
class TestJournalHandler(AccountConsolidationTestCase):
    ...
    @patch('tele.applets.account_consolidation.report.handler.periods.PeriodsHandler.is_set')
    @patch('tele.applets.account_consolidation.report.handler.journals.JournalsHandler.get_option_values')
...
class TestPeriodsHandler(AccountConsolidationTestCase):
    ...
    @patch('tele.applets.account_consolidation.report.handler.periods.PeriodsHandler.get_selected_values',
           return_value=[1, 3])
...
class TestShowZeroHandler(AccountConsolidationTestCase):
    @patch('tele.applets.account_consolidation.report.handler.show_zero.ShowZeroHandler._line_is_not_zero')
    ...
    @patch('tele.applets.account_consolidation.report.handler.show_zero.ShowZeroHandler._section_line_is_not_zero')
    @patch('tele.applets.account_consolidation.report.handler.show_zero.ShowZeroHandler._section_line_has_children')
