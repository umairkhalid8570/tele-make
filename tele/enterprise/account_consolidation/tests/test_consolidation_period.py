...
class TestConsolidationPeriod(AccountConsolidationTestCase):
    ...
    @patch(
        'tele.applets.account_consolidation.models.consolidation_period.ConsolidationPeriod._get_previous_similiar_period',
        return_value=False)
    @patch(
        'tele.applets.account_consolidation.models.consolidation_period.ConsolidationPeriod._get_company_periods_default_values_from_chart',
        return_value=[])
    ...
    @patch(
        'tele.applets.account_consolidation.models.consolidation_period.ConsolidationPeriod._get_previous_similiar_period')
    @patch(
        'tele.applets.account_consolidation.models.consolidation_period.ConsolidationPeriod._get_company_periods_default_values_from_period',
        return_value=[])
...
class TestConsolidationPeriodComposition(AccountConsolidationTestCase):
    ...
    @patch(
        'tele.applets.account_consolidation.models.consolidation_period.ConsolidationPeriod.action_generate_journals',
        return_value=False)
    ...
    @patch(
        'tele.applets.account_consolidation.models.consolidation_period.ConsolidationPeriodComposition._get_default_currency_rate',
        return_value=2.0)
    ...
    @patch('tele.applets.base.models.res_currency.Currency._get_conversion_rate', return_value=150.0)
...
class TestConsolidationCompanyPeriod(AccountConsolidationTestCase):
    ...
    @patch(
        'tele.applets.account_consolidation.models.consolidation_period.ConsolidationCompanyPeriod._get_total_balance_and_audit_lines',
        return_value=(42.0, []))
    @patch(
        'tele.applets.account_consolidation.models.consolidation_period.ConsolidationCompanyPeriod._apply_rates',
    ...
    @patch(
        'tele.applets.account_consolidation.models.consolidation_period.ConsolidationCompanyPeriod._convert')
    @patch(
        'tele.applets.account_consolidation.models.consolidation_period.ConsolidationCompanyPeriod._apply_consolidation_rate')
