...
class TestAccountConsolidationJournal(AccountConsolidationTestCase):
    ...
    @patch(
        'tele.applets.account_consolidation.models.consolidation_period.ConsolidationPeriodComposition.get_journal_lines_values')
    @patch(
        'tele.applets.account_consolidation.models.consolidation_period.ConsolidationCompanyPeriod.get_journal_lines_values')
