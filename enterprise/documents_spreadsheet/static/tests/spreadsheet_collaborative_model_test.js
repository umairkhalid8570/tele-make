/** @tele-module alias=documents_spreadsheet.SpreadsheetCollaborativeModelTests */
...
QUnit.test("Add a list", async (assert) => {
    ...
    alice.dispatch("BUILD_TELE_LIST", {
        sheetId,
        list,
        anchor: [0, 0],
        linesNumber: 5,
...
QUnit.test("Can undo a command before a BUILD_TELE_LIST", async (assert) => {
    assert.expect(1);
