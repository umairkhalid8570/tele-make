/** @tele-module alias=ds.Constants default=0 */
...
export const HEADER_STYLE = { fillColor: "#fcfcfc" };
export const TOP_LEVEL_STYLE = { bold: true, fillColor: "#fcfcfc" };
export const MEASURE_STYLE = { fillColor: "#fcfcfc", textColor: "#756f6f" };
