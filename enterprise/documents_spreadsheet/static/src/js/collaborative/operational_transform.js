/** @tele-module alias=documents_spreadsheet.OperationalTransform */
...
otRegistry
    ...
    .addTransformation("ADD_TELE_LIST", ["ADD_TELE_LIST_FORMULA"], (toTransform) => ({
        ...toTransform,
        args: [toTransform.args[0] + 1, ...toTransform.args.slice(1)],
    }))
    .addTransformation("ADD_TELE_LIST", ["ADD_TELE_LIST"], (toTransform) => ({
        ...toTransform,
...
inverseCommandRegistry
    ...
    .add("ADD_TELE_LIST", identity)
    .add("ADD_TELE_LIST_FORMULA", identity);
