...
from tele import api, fields, models, http, _, Command
from tele.tools import DEFAULT_SERVER_DATE_FORMAT, config, get_lang, is_html_empty, formataddr
from tele.exceptions import UserError, ValidationError

TTFSearchPath.append(os.path.join(config["root_path"], "..", "applets", "web", "static", "fonts", "sign"))
...
class SignRequest(models.Model):
    ...
    def _message_send_mail(self, body, notif_template_xmlid, message_values, notif_values, mail_values, force_send=False, **kwargs):
        ...
        # See @tde-banana-tele for details
