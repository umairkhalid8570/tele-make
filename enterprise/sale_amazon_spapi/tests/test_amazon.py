...
from tele.applets.sale_amazon_spapi import utils as amazon_utils
from tele.applets.sale_amazon_spapi.tests import common
...
class TestAmazon(common.TestAmazonCommon):
    ...
    @mute_logger('tele.applets.sale_amazon_spapi.models.amazon_account')
    def test_update_marketplaces_no_change(self):
        ...
        with patch(
            'tele.applets.sale_amazon_spapi.models.amazon_account.AmazonAccount'
    ...
    def test_sync_orders_full(self):
        ...
        with patch(
            'tele.applets.sale_amazon_spapi.utils.make_proxy_request',
            return_value=common.AWS_RESPONSE_MOCK,
        ), patch(
            'tele.applets.sale_amazon_spapi.utils.make_sp_api_request',
            new=lambda _account, operation, **kwargs: common.OPERATIONS_RESPONSES_MAP[operation],
        ), patch(
            'tele.applets.sale_amazon.models.amazon_account.AmazonAccount._recompute_subtotal',
            new=lambda self_, subtotal_, *args_, **kwargs_: subtotal_,
        ), patch(
            'tele.applets.sale_amazon.models.amazon_account.AmazonAccount._get_product',
    ...
    def test_sync_orders_partial(self):
        ...
        with patch(
            ...
            'tele.applets.sale_amazon_spapi.utils.make_sp_api_request', new=get_sp_api_response_mock
        ):
            self.account.aws_credentials_expiry = '1970-01-01'  # The field is not stored.
    ...
    @mute_logger('tele.applets.sale_amazon_spapi.models.amazon_account')
    @mute_logger('tele.applets.sale_amazon_spapi.models.stock_picking')
    ...
    def test_sync_pickings(self):
        ...
        with patch(
            ...
            'tele.applets.sale_amazon_spapi.utils.submit_feed',
