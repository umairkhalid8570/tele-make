...
from tele.applets.social_facebook.models.social_post import SocialPostFacebook
from tele.applets.social_facebook.models.social_stream import SocialStreamFacebook
from tele.applets.social_facebook.tests.common import SocialFacebookCommon
...
class SocialFacebookCase(SocialFacebookCommon):
    ...
    def test_format_facebook_message(self):
        ...
        message = "Hi, Social is so cool :) Thanks Tele"
        tags = [{
            'id': 1337,
            'name': 'Tele - Social',
            'offset': 32,
        ...
        excepted_message = "Hi, Social is so cool :) Thanks @[1337] Tele-Social"
        self.assertEqual(
            social_stream._format_facebook_message(message, tags),
            excepted_message)

        message = "Hi, Social is so cool :) Thanks Tele @[45] thisisafaketag Tag another@[45] faketag"
        tags = [
            {
                'id': 1337,
                'name': 'Tele - Social',
                ...
                'id': 1338,
                'name': 'Tele Mate and - Social',
                'offset': 58,
                'length': 3
            }]
        excepted_message = "Hi, Social is so cool :) Thanks @[1337] Tele-Social @ [45] thisisafaketag @[1338] Tele-Mate-and-Social another@[45] faketag"
        self.assertEqual(
            social_stream._format_facebook_message(message, tags),
            excepted_message)
