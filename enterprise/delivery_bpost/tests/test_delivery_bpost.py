...
from tele.tests import TransactionCase, tagged, Form
from tele.applets.delivery_bpost.models.delivery_bpost import TRACKING_REF_DELIM
...
class TestDeliveryBpost(TransactionCase):
    ...
    def setUp(self):
        ...
        self.your_company.write({'name': 'Tele INC',
        ...
        self.agrolait.write({'name': 'Tele Brussels',
        ...
        self.think_big_system.write({'name': "Palais de l'Élysee",
                                 ...
                                 'phone': '0142928100'})
        self.teleinc = self.env['res.partner'].create({'name': "Tele-Inc.",
                                 'is_company': True,
