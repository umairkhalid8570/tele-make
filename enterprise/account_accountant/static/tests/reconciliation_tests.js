tele.define('account.reconciliation_tests.data', function () {
"use strict";
...
tele.define('account.reconciliation_tests', function (require) {
"use strict";
...
QUnit.module('account', {
    ...
    QUnit.test('Reconciliation validate without proposition', async function (assert) {
        assert.expect(1);
        // Test added to prevent this issue happening again: https://github.com/tele-studio/tele/commit/3549688b21eb65e16b9c3f2b6462eb8d8b52cd47
        var clientAction = new ReconciliationClientAction.StatementAction(null, this.params.options);
        await testUtils.mock.addMockEnvironment(clientAction, {
            data: this.params.data,
            session: this.params.session,
    ...
    QUnit.test('Reconciliation validate with proposition', async function (assert) {
        assert.expect(1);
        // Test added to check this functionality: https://github.com/tele-studio/tele/commit/2f3b469dee6f18cbccce1cdf2a81cfe57960c533
        var clientAction = new ReconciliationClientAction.StatementAction(null, this.params.options);
        await testUtils.mock.addMockEnvironment(clientAction, {
            data: this.params.data,
            session: this.params.session,
