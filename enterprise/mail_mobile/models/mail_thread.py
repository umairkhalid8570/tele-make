...
MOBILE_APP_IDENTIFIER = 'com.tele.mobile'
...
class MailThread(models.AbstractModel):
    ...
    def _notify_record_by_ocn(self, message, rdata, msg_vals=False, **kwargs):
        ...
        if not icp_sudo.get_param('tele_ocn.project_id') or not icp_sudo.get_param('mail_mobile.enable_ocn'):
            return
        ...
        # never send to author and to people outside of tele (email), except comments
        if msg_type == 'comment':
