...
from tele import models, fields, api, _, _lt
...
class IntrastatReport(models.AbstractModel):
    ...
    def _fill_supplementary_units(self, query_results):
        ...
        with the most accurate / relevant value, based on the available tele units of measure. When the customer does not have
