...
import utils from "tele_studio.utils";
import tour from "web_tour.tour";

tour.register(
    "tele_studio_home_menu_background_tour",
    {
        url: "/web",
        sequence: 260,
    },
    [
        {
            ...
            content: _t("Want to customize the background? Let’s activate <b>Tele Studio</b>."),
            position: "bottom",
        ...
        {
            trigger:
                ".o_tele_studio_home_studio_menu .dropdown-menu .dropdown-item.o_tele_studio_change_background",
...
tour.register(
    ...
    [
        ...
        {
            trigger: ".o_tele_studio_selectors .o_tele_studio_selector:eq(2)",
        ...
        {
            trigger:
                ".o_tele_studio_sidebar .o_tele_studio_field_type_container:eq(1) .o_tele_studio_field_char",
            content: _t(
        ...
        {
            trigger: ".o_tele_studio_form_view_editor td.o_td_label",
        ...
        },
        {
            ...
            extra_trigger: ".o_tele_studio_form_view_editor td.o_td_label:contains(My Field)",
        ...
        {
            trigger:
                ".o_tele_studio_sidebar .o_tele_studio_field_type_container:eq(1) .o_tele_studio_field_selection",
            content: _t(
        ...
        {
            trigger: ".o_tele_studio_field_dialog_form > .o_tele_studio_add_selection input",
            content: _t(
        ...
        {
            trigger:
                ".o_tele_studio_field_dialog_form > .o_tele_studio_add_selection .o_tele_studio_add_selection_value",
            auto: true,
        },
        {
        ...
        {
            trigger: ".o_tele_studio_sidebar_text",
            auto: true,
        },
        {
            trigger: ".o_tele_studio_form_view_editor .o_Chatter",
        ...
        {
            trigger: '.o_tele_studio_sidebar .o_display_chatter input[name="email_alias"]',
            content: _t(
        ...
        {
            trigger: ".o_tele_studio_leave",
            content: _t(
                "Let’s check the result. Close Tele Studio to get an <b>overview of your app</b>."
            ),
            position: "left",
        },
        {
        ...
        },
        {
            ...
            content: _t(
                "Wow, nice! And I’m sure you can make it even better! Use this icon to open <b>Tele Studio</b> and customize any screen."
            ),
            position: "bottom",
        },
        {
            trigger: ".o_tele_studio_menu .o_menu_sections li:contains(Views)",
            content: _t("Want more fun? Let’s create more <b>views</b>."),
            position: "bottom",
        },
        {
            trigger:
                '.o_tele_studio_view_category .o_tele_studio_view_type.o_tele_studio_inactive[data-type="kanban"] .o_tele_studio_thumbnail',
