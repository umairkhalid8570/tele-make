...
export class IconCreatorDialog extends Dialog {
    ...
    async saveIcon() {
        ...
        if (iconValue) {
            await this.rpc("/tele_studio/edit_menu_icon", {
...
IconCreatorDialog.contentClass = "o_tele_studio_edit_menu_icon_modal";
IconCreatorDialog.size = "modal-md";
IconCreatorDialog.bodyTemplate = "tele_studio.IconCreatorDialogBody";
IconCreatorDialog.footerTemplate = "tele_studio.IconCreatorDialogFooter";
