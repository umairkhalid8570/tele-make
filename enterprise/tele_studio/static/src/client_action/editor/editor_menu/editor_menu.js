...
export class EditorMenu extends owl.Component {
    setup() {
        ...
        const toggleUndo = (display) => {
            const el = this.el.querySelector(".o_tele_studio_undo");
            if (el) {
                el.classList.toggle("o_tele_studio_active", display);
            }
        };
        const toggleRedo = (display) => {
            const el = this.el.querySelector(".o_tele_studio_redo");
            if (el) {
                el.classList.toggle("o_tele_studio_active", display);
            }
        };
        ...
        const toggleSnackBar = (type) => {
            const snackBarIcon = this.el.querySelector(".o_tele_studio_snackbar_icon");
            const snackBarText = this.el.querySelector(".o_tele_studio_snackbar_text");
            switch (type) {
                case "saved":
...
EditorMenu.template = "tele_studio.EditorMenu";
...
editorTabRegistry
    .add("views", { name: _lt("Views"), action: "tele_studio.action_editor" })
