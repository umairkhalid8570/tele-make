...
const actionServiceStudio = {
    ...
    start(env) {
        ...
        async function doAction(actionRequest, options) {
            if (actionRequest === "tele_studio.action_edit_report") {
...
export class Editor extends Component {
    ...
    async getStudioAction() {
        ...
        if (tab.action) {
            ...
            return "tele_studio.report_editor";
        } else {
            return this.rpc("/tele_studio/get_studio_action", {
...
Editor.template = "tele_studio.Editor";
Editor.components = {
    EditorMenu,
