...
import ActionEditor from "tele_studio.ActionEditor";
import bus from "tele_studio.bus";
import ViewEditorManager from "tele_studio.ViewEditorManager";
...
export const ActionEditorMain = Widget.extend({
    ...
    start: function () {
        var self = this;
        var def;
        this.$el.addClass("o_tele_studio_client_action");
    ...
    _getStudioViewArch: function (model, view_type, view_id) {
        ...
        core.bus.trigger("clear_cache");
        return this._rpc({
            route: "/tele_studio/get_studio_view_arch",
            params: {
                model: model,
                view_type: view_type,
                view_id: view_id,
    ...
    _isActivityAllowed: function () {
        ...
        return this._rpc({
            route: "/tele_studio/activity_allowed",
            params: {
                model: modelName,
            },
    ...
    _isChatterAllowed: function () {
        ...
        return this._rpc({
            route: "/tele_studio/chatter_allowed",
            params: {
                model: res_model,
            },
    ...
    _writeViewMode: function (view_mode, initial_view_mode) {
        ...
        return def.then(function (result) {
            ...
            return self.do_action("action_tele_studio_action_editor", {
                action: result,
                noEdit: true,
            });
        });
