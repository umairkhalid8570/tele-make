tele.define('tele_studio.view_components', function (require) {
"use strict";
...
var AbstractComponent = Widget.extend({
    ...
    start: function () {
        var self = this;
        this.$el.addClass('o_tele_studio_component');
        this.$el.data('structure', this.structure);
        this.$el.text(this.label);
        if (config.isDebug() && this.description) {
            this.$el.addClass('o_tele_studio_debug');
            this.$el.append($('<div>')
                .addClass('o_tele_studio_component_description')
...
var NotebookComponent = AbstractComponent.extend({
    ...
    label: _lt('Tabs'),
    type: 'tabs',
    className: 'o_tele_studio_field_tabs',
});
var GroupComponent = AbstractComponent.extend({
    structure: 'group',
    label: _lt('Columns'),
    type: 'columns',
    className: 'o_tele_studio_field_columns',
});
var FilterComponent = AbstractComponent.extend({
    structure: 'filter',
    label: _lt('Filter'),
    type: 'filter',
    className: 'o_tele_studio_filter',
});
var FilterSeparatorComponent = AbstractComponent.extend({
    structure: 'separator',
    label: _lt('Separator'),
    type: 'separator',
    className: 'o_tele_studio_filter_separator',
});
...
var ExistingFieldComponent = AbstractComponent.extend({
    ...
    init: function (parent, name, field_description, type, store, attrs) {
        ...
        this.className = 'o_tele_studio_field_' + type;
        this.type = type;
        this.store = store;
        this.fieldAttrs = attrs;
    },
