tele.define('tele_studio.studio_report_kanban', function (require) {
"use strict";
...
var StudioReportKanbanController = KanbanController.extend({
    ...
    _openReportRecord: function (data) {
        ...
        Promise.resolve(def).then(function (result) {
            ...
            self.do_action('tele_studio.action_edit_report', {
                report: report,
...
var NewReportDialog = Dialog.extend({
    template: 'tele_studio.NewReportDialog',
    events: {
        'click .o_tele_studio_report_layout_item': '_onReportTemplateSelected',
    },
    /**
     * @constructor
     * @param {Widget} parent
    ...
    _createNewReport: function (modelName, layout) {
        return this._rpc({
            route: '/tele_studio/create_new_report',
            params: {
