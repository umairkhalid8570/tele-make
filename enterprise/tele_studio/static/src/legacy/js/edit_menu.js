tele.define('tele_studio.EditMenu', function (require) {
"use strict";
...
var MenuItem = Widget.extend({
    template: 'tele_studio.EditMenu.MenuItem',
    events: {
...
var EditMenuDialog = Dialog.extend({
    template: 'tele_studio.EditMenu.Dialog',
...
const NewMenuDialog = CommonMenuDialog.extend({
    template: 'tele_studio.EditMenu.Dialog.New',
    ...
    start: function () {
        ...
        this.opened().then(function () {
            self.$modal.addClass('o_tele_studio_add_menu_modal');
            // focus on input
