tele.define('tele_studio.AbstractEditorManager', function (require) {
"use strict";
...
var XMLEditor = require('tele_studio.XMLEditor');

var _lt = core._lt;
var _t = core._t;

var AbstractEditorManager = Widget.extend({
    className: 'o_tele_studio_editor_manager',
    custom_events: {
    ...
    _updateSidebar: function (mode, params) {
        ...
        if  (this.sidebar.$el) {
            ...
            // TODO: scroll top is calculated to 'o_tele_studio_sidebar_content'
