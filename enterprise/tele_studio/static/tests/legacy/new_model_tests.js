tele.define('tele_studio.NewModeltests', function (require) {
"use strict";

const NewModel = require('tele_studio.NewModel');
    ...
    QUnit.test('Add New Model', async function (assert) {
        ...
        testUtils.mock.addMockEnvironment(newModel, {
            mockRPC: function (route, args) {
                if (route === "/tele_studio/create_new_menu") {
        ...
        assert.containsNone($, '.o_tele_studio_new_model_modal',
        ...
        assert.containsOnce($, '.o_tele_studio_new_model_modal',
        ...
        const $configuratorModal = $('.o_tele_studio_model_configurator');
        ...
        await testUtils.dom.click($configuratorModal.find('.o_tele_studio_model_configurator_next'));
