tele.define('tele_studio.form_tests', function (require) {
    'use strict';

    const FormView = require('web.FormView');
    const testUtils = require('web.test_utils');
    require('tele_studio.FormRenderer');
    require('tele_studio.FormController');
    ...
    QUnit.module(
        ...
        function () {
            ...
            QUnit.test('approval widget basic rendering', async function (assert) {
                ...
                assert.containsOnce(form, 'button[name="someMethod"] .o_tele_studio_approval');
                assert.containsOnce(form, '#visibleStat .o_tele_studio_approval');
                assert.containsNone(form, '#invisibleStat .o_tele_studio_approval');
                assert.containsOnce(form, 'button[name="anotherMethod"] .o_tele_studio_approval');
                assert.containsNone(form, '.o_group .o_tele_studio_approval');
                ...
                // display popover
                await testUtils.dom.click('button[name="someMethod"] .o_tele_studio_approval');
                assert.containsOnce($(document), '.o_popover');
                const popover = $(document).find('.o_popover');
                assert.containsOnce(popover, '.o_tele_studio_approval_no_entry');
