tele.define('tele_studio.testUtils', function (require) {
"use strict";
...
var ReportEditorManager = require('tele_studio.ReportEditorManager');
var ReportEditorSidebar = require('tele_studio.ReportEditorSidebar');
var ViewEditorManager = require('tele_studio.ViewEditorManager');
...
async function createReportEditor(params) {
        ...
        start: function () {
            ...
            this._super.apply(this, arguments).then(function () {
                var $studio = $.parseHTML(
                    "<div class='o_tele_studio_client_action'>" +
                            "<div class='o_tele_studio_editor_manager o_tele_studio_report_editor_manager'/>" +
                        "</div>" +
                    "</div>");
    ...
    return parent.appendTo(selector).then(function () {
        ...
        return editor.appendTo(parent.$('.o_tele_studio_editor_manager')).then(function () {
            return editor;
        });
    });
}
...
async function createReportEditorManager(params) {
    ...
    dom.append(parent.$('.o_tele_studio_client_action'), fragment, {
...
async function createSidebar(params) {
    ...
    return sidebar.appendTo(fragment).then(function () {
        sidebar.$el.appendTo(parent.$('.o_tele_studio_editor_manager'));
        return sidebar;
    });
}
