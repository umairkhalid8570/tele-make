...
patch(MockServer.prototype, "tele_studio.MockServer", {
    performRPC(route, args) {
        if (route === "/tele_studio/activity_allowed") {
            return Promise.resolve(this.mockActivityAllowed());
        }
        if (route === "/tele_studio/get_studio_view_arch") {
        ...
        if (route === "/tele_studio/get_studio_action") {
