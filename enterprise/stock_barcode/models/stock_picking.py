...
from tele.tools import html2plaintext, is_html_empty
...
class StockPicking(models.Model):
    ...
    def _create_new_picking(self, picking_type):
        ...
        :param picking_type:
        :type picking_type: :class:`~tele.applets.stock.models.stock_picking.PickingType`
        :return: a new picking
        :rtype: :class:`~tele.applets.stock.models.stock_picking.Picking`
        """
