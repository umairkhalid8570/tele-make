tele.define('hr_contract_salary', function (require) {
"use strict";
...
publicWidget.registry.SalaryPackageWidget = publicWidget.Widget.extend({
    ...
    async onchangeAdvantage(event) {
        // Check that https://github.com/tele-studio/enterprise/commit/e4fdb4df1d0d6aa5e8880ce1b4cc289a075479fd#diff-aa5bcb2caed35c99a7bd3e018a104342 is still valid
