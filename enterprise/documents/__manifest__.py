# -*- coding: utf-8 -*-
{
    ...
    'version': '1.1',
    'application': True,
    'website': 'https://www.tele.studio/app/documents',
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'documents/static/src/twl/components/pdf_manager/pdf_manager.js',
            'documents/static/src/twl/components/pdf_page/pdf_page.js',
            'documents/static/src/twl/components/pdf_group_name/pdf_group_name.js',
            ...
            'documents/static/src/twl/components/pdf_manager/pdf_manager.scss',
            'documents/static/src/twl/components/pdf_page/pdf_page.scss',
            'documents/static/src/twl/components/pdf_group_name/pdf_group_name.scss',
        ],
        ...
        'web.assets_qweb': [
            ...
            'documents/static/src/twl/components/pdf_manager/pdf_manager.xml',
            'documents/static/src/twl/components/pdf_page/pdf_page.xml',
            'documents/static/src/twl/components/pdf_group_name/pdf_group_name.xml',
        ],
    }
}
