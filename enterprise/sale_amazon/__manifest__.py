...

{
    ...
    'description': """
Import your Amazon orders in Tele and synchronize deliveries
============================================================

Key Features
------------
* Import orders from multiple accounts and marketplaces.
* Orders are matched with Tele products based on their internal reference (SKU in Amazon).
* Deliveries confirmed in Tele are synchronized in Amazon.
