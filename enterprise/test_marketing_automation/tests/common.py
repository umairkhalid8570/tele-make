...
class TestMACommon(TestMailFullCommon):
    ...
    def setUpClass(cls):
        ...
        cls.patcher = patch('tele.applets.marketing_automation.models.marketing_campaign.Datetime', wraps=Datetime)
        cls.patcher2 = patch('tele.applets.marketing_automation.models.marketing_activity.Datetime', wraps=Datetime)
        cls.patcher3 = patch('tele.applets.marketing_automation.models.marketing_participant.Datetime', wraps=Datetime)
        cls.patcher4 = patch('tele.applets.marketing_automation.models.marketing_trace.Datetime', wraps=Datetime)
        cls.patcher5 = patch('tele.applets.marketing_automation_sms.models.marketing_activity.Datetime', wraps=Datetime)
