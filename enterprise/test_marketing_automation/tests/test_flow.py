...
from tele.applets.test_marketing_automation.tests.common import TestMACommon
...
for record in records:
    ...
    @mute_logger('tele.applets.base.models.ir_model', 'tele.applets.mail.models.mail_mail')
    @users('user_markauto')
