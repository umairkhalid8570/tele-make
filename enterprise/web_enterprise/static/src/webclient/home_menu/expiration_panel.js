...
export class ExpirationPanel extends Component {
    ...
    async _onBuy() {
        ...
        browser.location = `https://www.tele.studio/tele-enterprise/upgrade?num_users=${nbUsers}`;
    }
    ...
    async _onRenew() {
        ...
        if (expirationDateStr !== oldDate && expirationDate > DateTime.utc()) {
            ...
            const url = "https://www.tele.studio/tele-enterprise/renew";
    ...
    async _onUpsell() {
        ...
        const url = "https://www.tele.studio/tele-enterprise/upsell";
        const contractQueryString = enterpriseCode ? `&contract=${enterpriseCode}` : "";
