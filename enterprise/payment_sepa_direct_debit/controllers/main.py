...
from tele.applets.base_iban.models.res_partner_bank import validate_iban
from tele.applets.iap.tools import iap_tools
from tele.applets.payment_sepa_direct_debit.models.sdd_mandate import INT_PHONE_NUMBER_FORMAT_REGEX
from tele.applets.phone_validation.tools.phone_validation import phone_sanitize_numbers
