...
In Tele, the configuration should be done in the user's preferences.
...
The extension of your office's phone is not a required field but it is used if you want to transfer your call from Tele to an external phone also configured in the sip.conf file.
