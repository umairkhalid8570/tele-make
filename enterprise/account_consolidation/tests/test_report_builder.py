...
from tele.applets.account_consolidation.tests.account_consolidation_test_classes import AccountConsolidationTestCase
from tele.applets.account_consolidation.report.builder.comparison import ComparisonBuilder
from tele.applets.account_consolidation.report.builder.comparison import ComparisonBuilder
from tele.applets.account_consolidation.report.builder.default import DefaultBuilder
from tele.tools.misc import NON_BREAKING_SPACE
...
class TestAbstractBuilder(AccountConsolidationTestCase):
    ...
    @patch('tele.applets.account_consolidation.report.builder.comparison.ComparisonBuilder._get_hierarchy')
    @patch('tele.applets.account_consolidation.report.builder.comparison.ComparisonBuilder._get_plain')
    ...
    @patch('tele.applets.account_consolidation.report.builder.comparison.ComparisonBuilder._handle_accounts')
    @patch('tele.applets.account_consolidation.report.builder.comparison.ComparisonBuilder._build_total_line')
    ...
    @patch('tele.applets.account_consolidation.report.builder.comparison.ComparisonBuilder._handle_orphan_accounts')
    @patch('tele.applets.account_consolidation.report.builder.comparison.ComparisonBuilder._get_root_sections')
    @patch('tele.applets.account_consolidation.report.builder.comparison.ComparisonBuilder._handle_sections')
    @patch('tele.applets.account_consolidation.report.builder.comparison.ComparisonBuilder._build_total_line')
    ...
    @patch('tele.applets.account_consolidation.report.builder.comparison.ComparisonBuilder._build_section_line')
    @patch(
        'tele.applets.account_consolidation.report.handler.show_zero.ShowZeroHandler.section_line_should_be_added',
        return_value=True)
    ...
    @patch('tele.applets.account_consolidation.report.builder.comparison.ComparisonBuilder._get_orphan_accounts')
    @patch('tele.applets.account_consolidation.report.builder.comparison.ComparisonBuilder._handle_accounts')
    ...
    @patch('tele.applets.account_consolidation.report.builder.comparison.ComparisonBuilder._compute_account_totals')
    @patch('tele.applets.account_consolidation.report.builder.comparison.ComparisonBuilder._format_account_line')
    @patch('tele.applets.account_consolidation.report.handler.show_zero.ShowZeroHandler.account_line_should_be_added',
           return_value=True)
...
class TestComparisonBuilder(AccountConsolidationTestCase):
    ...
    @patch('tele.applets.account_consolidation.report.handler.show_zero.ShowZeroHandler.section_line_should_be_added',
           return_value=True)
    @patch('tele.applets.account_consolidation.report.handler.show_zero.ShowZeroHandler.account_line_should_be_added',
           return_value=True)
    @patch('tele.applets.account_consolidation.report.builder.comparison.ComparisonBuilder._compute_account_totals')
    ...
    @patch('tele.applets.account_consolidation.report.builder.comparison.ComparisonBuilder._build_percentage_column',
