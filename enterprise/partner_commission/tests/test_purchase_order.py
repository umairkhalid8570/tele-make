...
from tele.tests.common import Form, tagged
from tele.applets.partner_commission.tests.setup import Line, Spec, TestCommissionsSetup
...
class TestPurchaseOrder(TestCommissionsSetup):
    def test_automatic_confirm(self):
        ...
        # Case: OK.
        with patch('tele.fields.Date.today', today):
            with patch('tele.applets.mail.models.mail_template.MailTemplate.send_mail', _patched_send_mail):
