...
class AccountBankReconciliationReport(models.AbstractModel):
        ...
        return (
            self._build_section_report_lines(options, journal, plus_report_lines, plus_total,
                ...
                _("%s for Transactions(+) imported from your online bank account (dated today) that "
                  "are not yet reconciled in Tele (Waiting the final reconciliation allowing finding the right "
    ...
    def _get_payment_report_lines(self, options, journal):
        ...
        return (
            self._build_section_report_lines(options, journal, plus_report_lines, plus_total,
                ...
                _("Transactions(+) that were entered into Tele, but not yet reconciled (Payments triggered by "
    ...
    def _get_lines(self, options, line_id=None):
        ...
        balance_gl_report_line = {
            ...
            'title_hover': _("The Book balance in Tele dated today"),
            'columns': self._apply_groups([
        ...
        if plus_pay_lines or less_pay_lines:
            ...
            outstanding_payments_report_line = {
                ...
                'title_hover': _("Transactions that were entered into Tele, but not yet reconciled (Payments triggered by invoices/bills or manually)"),
                'columns': self._apply_groups([
                    {'name': ''},
                    {'name': ''},
                    {'name': ''},
