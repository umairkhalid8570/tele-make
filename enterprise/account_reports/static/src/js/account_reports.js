tele.define('account_reports.account_report', function (require) {
'use strict';
...
var accountReportsWidget = AbstractAction.extend({
    ...
    init: function(parent, action) {
        ...
        this.tele_context = action.context;
    ...
    start: async function() {
        ...
        if("default_filter_accounts" in (this.tele_context || {}))
            this.$('.o_account_reports_filter_input').val(this.tele_context.default_filter_accounts).trigger("input");
    },
    ...
    parse_reports_informations: function(values) {
        ...
        this.tele_context = values.context;
    ...
    trigger_action: function(e) {
        ...
        var context = new Context(this.tele_context, params.actionContext || {}, {active_id: id});
