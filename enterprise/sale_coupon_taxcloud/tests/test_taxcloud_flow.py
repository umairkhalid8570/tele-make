...
class TestSaleCouponTaxCloudFlow(common.TestSaleCouponTaxCloudCommon):
    ...
    def setUp(self):
        ...
        patchers = [
            ...
            patch('tele.applets.account_taxcloud.models.taxcloud_request.TaxCloudRequest.verify_address', self._verify_address),
            patch('tele.applets.account_taxcloud.models.taxcloud_request.TaxCloudRequest.get_all_taxes_values', self._get_all_taxes_values),
        ]
        for p in patchers:
            p.start()
