...
from tele.applets.account_auto_transfer.tests.account_auto_transfer_test_classes import AccountAutoTransferTestCase

from tele import fields
from tele.models import ValidationError
...
class TransferModelTestCase(AccountAutoTransferTestCase):
    @patch('tele.applets.account_auto_transfer.models.transfer_model.TransferModel.action_perform_auto_transfer')
    ...
    @patch('tele.applets.account_auto_transfer.models.transfer_model.TransferModel._create_or_update_move_for_period')
    ...
    @patch('tele.applets.account_auto_transfer.models.transfer_model.TransferModel._get_auto_transfer_move_line_values')
    ...
    @patch('tele.applets.account_auto_transfer.models.transfer_model.TransferModel._get_non_analytic_transfer_values')
    @patch('tele.models.BaseModel.read_group')
    ...
    @patch(
        'tele.applets.account_auto_transfer.models.transfer_model.TransferModelLine._get_destination_account_transfer_move_line_values')
