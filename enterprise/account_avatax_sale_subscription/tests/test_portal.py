...
from tele.applets.account_avatax_sale_subscription.controllers.portal import SaleSubscriptionAvatax, PaymentPortalAvatax
...
class TestWebsiteSaleSubscriptionAvatax(TestSaleSubscriptionAvalaraCommon):
    ...
    def test_02_portal_transaction_creation(self):
        ...
        with WebsiteSaleSubMockRequest(self.env, qcontext={'account': self.subscription}), \
             ...
             patch('tele.applets.account_avatax.models.account_move.AccountMove.button_update_avatax') as mocked_button_update_avatax_on_inv:
