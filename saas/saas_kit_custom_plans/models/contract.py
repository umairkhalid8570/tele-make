...
class ContractCustomPlan(models.Model):
    ...
    tele_version_id = fields.Many2one(comodel_name="saas.tele.version")
    ...
    def set_user_data(self, token=False):
        for obj in self:
            ...
            if obj.is_custom_plan:
                ...
                data['user_id'] = obj.tele_version_id.template_user_id and int(obj.tele_version_id.template_user_id)
                data['user_data'] = dict(
    ...
    def add_apps(self, apps, contract_id):
        ...
        config = contract_id.tele_version_id.get_default_saas_values()
        multiplier = 1
