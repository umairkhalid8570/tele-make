...
{
  "name"                 :  "Tele SaaS",
  "summary"              :  """Tele As A SaaS business.""",
  ...
  "description"          :  """Provide Tele as a Service(Saas) on your servers with Tele Saas.""",
  "live_test_url"        :  "http://teledemo.tele.studio/demo_feedback?module=tele_saas_kit",
  "depends"              :  [
                             'sale_management',
                             'portal',
                             'base',
