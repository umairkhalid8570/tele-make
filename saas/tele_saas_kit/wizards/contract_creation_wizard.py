    ...
    def action_create_contract(self):
        for obj in self:
            ...
            try:
                ...
                # action = imd._xmlid_to_res_id('tele_saas_kit.saas_contract_action')
                model, action  = imd.check_object_reference('tele_saas_kit', 'saas_contract_action')
                action = self.env[model].sudo().browse([action])
                list_view_id = imd._xmlid_to_res_id('tele_saas_kit.saas_contract_tree_view')
                form_view_id = imd._xmlid_to_res_id('tele_saas_kit.saas_contract_form_view')
