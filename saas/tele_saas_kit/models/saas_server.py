...
SERVER_TYPE = [
    ...
    # ('same_tele_server', "Current Tele Server"),
    # ('different_tele_server', "Same machine with different tele server"),
    # ('different_tele_server', "Different Tele Server"),
]
DB_SCHEME = [
...
class SaasServer(models.Model):
    ...
    tele_url = fields.Char(string="Tele URL")
