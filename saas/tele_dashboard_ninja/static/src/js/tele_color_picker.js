tele.define('tele_dashboard_ninja_list.tele_color_picker', function(require) {
    "use strict";
    ...
    var TeleColorPicker = AbstractField.extend({
        ...
        jsLibs: [
            '/tele_dashboard_ninja/static/lib/js/spectrum.js'
        ],
        cssLibs: [
            '/tele_dashboard_ninja/static/lib/css/spectrum.css',
        ],
