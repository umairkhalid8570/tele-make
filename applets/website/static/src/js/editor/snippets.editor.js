tele.define('website.snippet.editor', function (require) {
'use strict';
...
const TeleEditorLib = require('@web_editor/../lib/tele-editor/src/utils/utils');
const getDeepRange = TeleEditorLib.getDeepRange;
const getTraversedNodes = TeleEditorLib.getTraversedNodes;
...
weSnippetEditor.SnippetsMenu.include({
    ...
    _onAnimateTextClick(ev) {
        ...
        if (this.$currentAnimatedText.length) {
            ...
            this.options.wysiwyg.teleEditor.historyResetLatestComputedSelection();
            this._toggleHighlightAnimatedTextButton();
