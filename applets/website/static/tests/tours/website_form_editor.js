tele.define('website.tour.form_editor', function (require) {
    'use strict';
    ...
    tour.register("website_form_editor_tour", {
        ...
        ...addExistingField('email_cc', 'text', 'Test conditional visibility', false, {visibility: CONDITIONALVISIBILITY, condition: 'tele'}),
...

        {
            ...
            run: () => {
                ...
                wysiwyg.teleEditor.historyStep(true);
            },
        },
        ...
        },
        {
            ...
            trigger: '.s_website_form_field:eq(0) input[value="John Smith"]:propValue("Tele Admin")',
        },
        {
        ...
        },
        {
            ...
            run: function () {
                ...
                if (style.display !== 'none') {
                    console.error('error This field should be invisible when the name is not tele');
                }
            }
        },
        {
