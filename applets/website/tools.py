...
import tele
from tele.tools.misc import DotDict
...
def MockRequest(
    ...
    with contextlib.ExitStack() as s:
        tele.http._request_stack.push(request)
        s.callback(tele.http._request_stack.pop)
        s.enter_context(patch('tele.http.root.get_db_router', router))
