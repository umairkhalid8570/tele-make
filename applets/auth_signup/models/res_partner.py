...
class ResPartner(models.Model):
    ...
    signup_token = fields.Char(copy=False, groups="base.group_system_manager")
    signup_type = fields.Char(string='Signup Token Type', copy=False, groups="base.group_system_manager")
    signup_expiration = fields.Datetime(copy=False, groups="base.group_system_manager")
