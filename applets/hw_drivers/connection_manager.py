...
class ConnectionManager(Thread):
    ...
    def run(self):
        if not helpers.get_tele_server_url() and not helpers.access_point():
    ...
    def _connect_box(self):
        ...
        try:
            ...
            req = requests.post('https://iot-proxy.tele.studio/tele-enterprise/iot/connect-box', json=data, verify=False)
            ...
            _logger.error('Could not reach iot-proxy.tele.studio')
