...
from tele.applets.hw_drivers.connection_manager import connection_manager
...
from tele.applets.hw_drivers.iot_handlers.interfaces.PrinterInterface import PPDs, conn, cups_lock
...
class PrinterDriver(Driver):
    ...
    def send_status(self):
        """ Sends the current status of the printer to the connected Tele instance.
        """
        self.data = {
            'value': '',
            'state': self.state,
