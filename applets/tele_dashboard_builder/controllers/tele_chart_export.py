...
from tele.tools.misc import xlwt
from tele.exceptions import UserError
from tele.tools import pycompat


class TeleChartExport(http.Controller):
...
class TeleChartExcelExport(TeleChartExport, http.Controller):

    # Excel needs raw data to correctly handle numbers and date values
    raw_data = True

    @http.route('/tele_dashboard_builder/export/chart_xls', type='http', auth="user")
    @serialize_exception
    def index(self, data):
...
class TeleChartCsvExport(TeleChartExport, http.Controller):

    @http.route('/tele_dashboard_builder/export/chart_csv', type='http', auth="user")
    @serialize_exception
    def index(self, data):
        return self.base(data)
