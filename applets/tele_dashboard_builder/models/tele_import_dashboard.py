...
class TeleDashboardBuilderImport(models.TransientModel):
    _name = 'tele_dashboard_builder.import'
    ...
    def tele_do_action(self):
        for rec in self:
            try:
                ...
                self.env['tele_dashboard_builder.board'].tele_import_dashboard(tele_result, self.tele_top_menu_id)
                return {
