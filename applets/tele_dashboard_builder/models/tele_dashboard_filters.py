...
class TeleDashboardBuilderTemplate(models.Model):
    _name = 'tele_dashboard_builder.board_defined_filters'
    _description = 'Dashboard Builder Defined Filters'

    name = fields.Char("Filter Label")
    tele_dashboard_board_id = fields.Many2one('tele_dashboard_builder.board', string="Dashboard")
...
class TeleDashboardBuilderTemplate(models.Model):
    _name = 'tele_dashboard_builder.board_custom_filters'
    _description = 'Dashboard Builder Custom Filters'
