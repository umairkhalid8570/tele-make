tele.define('tele_dashboard_builder.quick_edit_view', function(require) {
    "use strict";
    ...
    var QuickEditView = Widget.extend({
        ...
        _teleCreateController: function() {
            ...
            self.context['form_view_ref'] = 'tele_dashboard_builder.item_quick_edit_form_view';
            self.context['res_id'] = this.item.id;
            self.res_model = "tele_dashboard_builder.item";
