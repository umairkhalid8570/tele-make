tele.define('tele_dashboard_builder.tele_dashboard', function(require) {
    "use strict";

    var core = require('web.core');
    const { patch } = require('web.utils');
    const { WebClient } = require("@web/webclient/webclient");
//    var export = require('tele_dashboard_builder.import_button');
    ...
    var TeleGlobalFunction = require('tele_dashboard_builder.TeleGlobalFunction');

    var TeleQuickEditView = require('tele_dashboard_builder.quick_edit_view');


    var TeleDashboardBuilder = AbstractAction.extend({
        ...
        jsLibs: [
            '/tele_dashboard_builder/static/lib/js/Chart.bundle.min.js',
            '/tele_dashboard_builder/static/lib/js/gridstack-h5.js',
            '/tele_dashboard_builder/static/lib/js/chartjs-plugin-datalabels.js',
            '/tele_dashboard_builder/static/lib/js/pdfmake.min.js',
            '/tele_dashboard_builder/static/lib/js/vfs_fonts.js',
        ],
        cssLibs: ['/tele_dashboard_builder/static/lib/css/Chart.css',
            '/tele_dashboard_builder/static/lib/css/Chart.min.css'
        ],
...
//            css_grid = $('.o_rtl').length>0 ?
            ...
            this.form_template = 'tele_dashboard_builder_template_view';
...
//            self.tele_fetch_data();
        ...
        teleOnDashboardImportClick: function(ev){
         ev.preventDefault();
            ...
            var dashboard_id = this.tele_dashboard_id;
            this._rpc({
                    model: 'tele_dashboard_builder.board',
         ...
         ev.preventDefault();
           ...
           var dashboard_id = JSON.stringify(this.tele_dashboard_id);
                ...
                self.getSession().get_file({
                    url: '/tele_dashboard_builder/export/dashboard_json',
                    data: {
...
//            $('#tele_dashboard_title_input').val(this.tele_dashboard_data.tele_child_boards[this.tele_dashboard_data.tele_selected_board_id][0]);
        ...
        teleRenderChartColorOptions: function(e) {
            ...
            if (!$(e.currentTarget).parent().hasClass('tele_date_filter_selected')) {
                ...
                this._rpc({
                    model: 'tele_dashboard_builder.item',
                    method: 'write',
...
//                result = self.normalize_dn_data(result);
        ...
        teleRenderDashboard: function() {
            var self = this;
            self.$el.empty();
            self.$el.addClass('tele_dashboard_builder d-flex flex-column');
            ...
            var $tele_header = $(QWeb.render('teleDashboardBuilderHeader', {
        ...
        onAddItemTypeClick: function(e) {
            ...
            if (e.currentTarget.dataset.item !== "tele_json") {
                self.do_action({
                    ...
                    view_id: 'tele_dashboard_builder_list_form_view',
                    views: [
                        [false, 'form']
                    ],
                    target: 'current',
                    context: {
                        ...
                        'form_view_ref': 'tele_dashboard_builder.item_form_view',
...
//                            framework.unblockUI();
        ...
        _onTeleSaveLayoutClick: function() {
            ...
            if (dashboard_title != false && dashboard_title != 0 && dashboard_title !== self.tele_dashboard_data.name) {
                ...
                var model = 'tele_dashboard_builder.board';
                ...
                if(this.tele_dashboard_data.tele_selected_board_id && this.tele_dashboard_data.tele_child_boards){
                    ...
                    if (this.tele_dashboard_data.tele_selected_board_id !== 'tele_default'){
                        model = 'tele_dashboard_builder.child_board';
            ...
            if (dashboard_title ==="") {
                ...
                this._rpc({
                    ...
                    args: ['create', self.tele_dashboard_id, {
                        ...
                        "tele_dashboard_builder_id": self.tele_dashboard_id,
                        "name": dashboard_title,
                        "tele_active": true,
...
//                    self.$el.find(".grid-stack-item[gs-id=" + item_data.id + "]").append(self.teleRenderToDoDashboardView(item_data));
       ...
       var self = this;
        ...
        _teleSaveCurrentLayout: function() {
            var self = this;
            var grid_config = self.tele_get_current_gridstack_config();
            var model = 'tele_dashboard_builder.child_board';
        ...
        onTeleDuplicateItemClick: function(e) {
            ...
            this._rpc({
                ...
                args: [parseInt(tele_item_id), {
                    'tele_dashboard_builder_board_id': parseInt(dashboard_id)
                }],
            }).then(function(result) {
...
//                  self.teleUpdateDashboardItem()
        ...
        teleChartExportXlsCsv: function(e) {
            ...
            this.getSession().get_file({
                url: '/tele_dashboard_builder/export/' + e.currentTarget.dataset.format,
                data: {
                    data: JSON.stringify(data)
                },
                complete: framework.unblockUI,
        ...
        teleItemExportJson: function(e) {
            ...
            framework.blockUI();
            this.getSession().get_file({
                url: '/tele_dashboard_builder/export/item_json',
                data: {
                    data: JSON.stringify(data)
                },
                complete: framework.unblockUI,
    ...
    core.action_registry.add('tele_dashboard_builder', TeleDashboardBuilder);
