tele.define('tele_dashboard_builder_list.tele_color_picker', function(require) {
    "use strict";
    ...
    var TeleColorPicker = AbstractField.extend({
        ...
        jsLibs: [
            '/tele_dashboard_builder/static/lib/js/spectrum.js'
        ],
        cssLibs: [
            '/tele_dashboard_builder/static/lib/css/spectrum.css',
        ],
