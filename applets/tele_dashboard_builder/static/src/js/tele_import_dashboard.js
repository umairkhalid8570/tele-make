tele.define('tele_dashboard_builder.import_button', function(require) {
...
//    var Sidebar = require('web.Sidebar');
    ...
    ListController.include({
       ...
       _getActionMenuItems: function (state) {
        ...
        if (this.modelName == "tele_dashboard_builder.board"){
    ...
    core.action_registry.add('tele_dashboard_builder.import_button', ListController);
