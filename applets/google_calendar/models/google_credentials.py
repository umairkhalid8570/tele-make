...
from tele.applets.google_account.models.google_service import GOOGLE_TOKEN_ENDPOINT
...
class GoogleCredentials(models.Model):
    ...
    calendar_cal_id = fields.Char('Calendar ID', copy=False, help='Last Calendar ID who has been synchronized. If it is changed, we remove all links between GoogleID and Tele Google Internal ID')
