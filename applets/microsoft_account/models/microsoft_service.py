...
class MicrosoftService(models.AbstractModel):
    ...
    def _get_authorize_uri(self, from_url, service, scope):
        """ This method return the url needed to allow this instance of Tele to access to the scope
        ...
        base_url = get_param('web.base.url', default='http://www.tele.studio?NoBaseUrl')
