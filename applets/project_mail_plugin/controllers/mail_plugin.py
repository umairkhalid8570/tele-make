...
from tele.applets.mail_plugin.controllers import mail_plugin
...
class MailPluginController(mail_plugin.MailPluginController):
    ...
    def _get_contact_data(self, partner):
        ...
        This is structured this way to enable the "project" feature on the Outlook side only if the Tele version
        supports it.
