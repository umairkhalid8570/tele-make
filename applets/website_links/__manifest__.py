...
Those trackers can be used in Google Analytics to track clicks and visitors, or in Tele reports to analyze the efficiency of those campaigns in terms of lead generation, related revenues (sales orders), recruitment, etc.
    """,
    'version': '1.0',
