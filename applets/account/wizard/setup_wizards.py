...
class FinancialYearOpeningWizard(models.TransientModel):
    ...
    opening_date = fields.Date(string='Opening Date', required=True, related='company_id.account_opening_date', help="Date from which the accounting is managed in Tele. It is the date of the opening entry.", readonly=False)
