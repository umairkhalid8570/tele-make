...
class MockLinkTracker(common.BaseCase):
    ...
    def setUp(self):
        ...
        link_tracker_title_patch = patch('tele.applets.link_tracker.models.link_tracker.LinkTracker._get_title_from_url', wraps=_get_title_from_url)
    ...
    def assertLinkShortenedHtml(self, body, link_info, link_params=None):
        ...
        self.assertLinkShortenedHtml(
            message.body,
            ('url0', 'http://www.tele.studio',  True),
