...

{
    ...
    'description': """
Integrate google document to Tele record.
============================================

This module allows you to integrate google documents to any of your Tele record quickly and easily using OAuth 2.0 for Installed Applications,
