...
from tele.fields import Datetime as FieldsDatetime, Date as FieldsDate
...
class TestEventData(TestEventCommon):
    ...
    def setUpClass(cls):
        ...
        cls.patcher = patch('tele.applets.event.models.event_event.fields.Datetime', wraps=FieldsDatetime)
...
class TestEventTicketData(TestEventCommon):
    ...
    def setUp(self):
        ...
        self.ticket_date_patcher = patch('tele.applets.event.models.event_ticket.fields.Date', wraps=FieldsDate)
        ...
        self.ticket_datetime_patcher = patch('tele.applets.event.models.event_ticket.fields.Datetime', wraps=FieldsDatetime)
