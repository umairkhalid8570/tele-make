...
Also, adds methods to convert values back to Tele models.
"""
...
from tele import _, api, models, fields
from tele.tools import ustr, posix_to_ldml, pycompat
from tele.tools import html_escape as escape
from tele.tools.misc import get_lang, babel_locale_parse
from tele.applets.base.models import ir_qweb
...
class Image(models.AbstractModel):
    ...
    def load_local_url(self, url):
        ...
        path = tele.modules.get_module_resource(
