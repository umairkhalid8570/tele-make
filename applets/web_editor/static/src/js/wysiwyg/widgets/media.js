tele.define('wysiwyg.widgets.media', function (require) {
'use strict';
...
/**
 * Let users choose a file, including uploading a new file in tele.
 */
var FileWidget = SearchableMediaWidget.extend({
     ...
     * @returns {Array} "ir.attachment" tele domain.
     */
...
/**
 * Let users choose an image, including uploading a new image in tele.
 */
...
/**
 * Let users choose a document, including uploading a new document in tele.
 */
