tele.define('wysiwyg.widgets.LinkTools', function (require) {
'use strict';
...
const LinkTools = Link.extend({
    ...
    _updateColorpicker: async function (cssProperty) {
        ...
        if (!colorpicker) {
            colorpicker = new ColorPaletteWidget(this, {
                ...
                $editable: $(this.options.wysiwyg.teleEditor.editable),
            ...
            colorpicker.on('custom_color_picked color_picked color_hover color_leave', this, (ev) => {
                ...
                if (['custom_color_picked', 'color_picked'].includes(ev.name)) {
                    ...
                    this.options.wysiwyg.teleEditor.execCommand('applyColor', '', 'color');
                    this.options.wysiwyg.teleEditor.execCommand('applyColor', '', 'backgroundColor');
                }
     ...
     */
    _addHintClasses () {
        this.options.wysiwyg.teleEditor.observerUnactive("hint_classes");
        this.$link.addClass('oe_edited_link');
        this.$button.addClass('active');
        this.options.wysiwyg.teleEditor.observerActive("hint_classes");
    },
    /**
    ...
    _removeHintClasses () {
        this.options.wysiwyg.teleEditor.observerUnactive("hint_classes");
        $(this.options.wysiwyg.teleEditor.document).find('.oe_edited_link').removeClass('oe_edited_link');
