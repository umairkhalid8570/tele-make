...
const testMultiEditor = spec => {
    ...
    for (const clientInfo of clientInfosList) {
        ...
        let nextId = 1;
        TeleEditor.prototype._generateId = () => 'fake_id_' + nextId++;

        clientInfo.editor = new TeleEditor(clientInfo.editable, {
            toSanitize: false,
    ...
    TeleEditor.prototype._generateId = () => 'fake_concurent_id_' + concurentNextId++;
