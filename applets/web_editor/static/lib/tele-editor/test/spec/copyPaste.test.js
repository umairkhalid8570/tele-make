...
import {CLIPBOARD_WHITELISTS} from "../../src/TeleEditor.js";
        ...
        describe('range collapsed', async () => {
            it('should paste and transform an image URL in a p', async () => {
                await testEditor(BasicEditor, {
                    contentBefore: '<p>ab[]cd</p>',
                    stepFunction: async editor => {
                        await pasteText(editor, 'https://download.telecdn.com/icons/website/static/description/icon.png');
                    ...
                    contentAfter: '<p>ab<img src="https://download.telecdn.com/icons/website/static/description/icon.png">[]cd</p>',
                });
            });
            it('should paste and transform an image URL in a span', async () => {
                await testEditor(BasicEditor, {
                    ...
                    contentAfter: '<p>a<span>b<img src="https://download.telecdn.com/icons/website/static/description/icon.png">[]c</span>d</p>',
                });
            });
            it('should paste and transform an image URL in an existing link', async () => {
                await testEditor(BasicEditor, {
                    ...
                    contentAfter: '<p>a<a href="http://existing.com">b<img src="https://download.telecdn.com/icons/website/static/description/icon.png">[]c</a>d</p>',
                });
            });
        });
        describe('range not collapsed', async () => {
