...
""",
    ...
    'assets': {
        ...
        'web_editor.assets_wysiwyg': [
            ...
            # tele-editor
            'web_editor/static/lib/tele-editor/src/style.css',
            'web_editor/static/lib/tele-editor/src/TeleEditor.js',
            'web_editor/static/lib/tele-editor/src/utils/constants.js',
            'web_editor/static/lib/tele-editor/src/utils/sanitize.js',
            'web_editor/static/lib/tele-editor/src/utils/serialize.js',
            'web_editor/static/lib/tele-editor/src/utils/DOMPurify.js',
            'web_editor/static/lib/tele-editor/src/tablepicker/TablePicker.js',
            'web_editor/static/lib/tele-editor/src/powerbox/patienceDiff.js',
            'web_editor/static/lib/tele-editor/src/powerbox/Powerbox.js',
            'web_editor/static/lib/tele-editor/src/commands/align.js',
            'web_editor/static/lib/tele-editor/src/commands/commands.js',
            'web_editor/static/lib/tele-editor/src/commands/deleteBackward.js',
            'web_editor/static/lib/tele-editor/src/commands/deleteForward.js',
            'web_editor/static/lib/tele-editor/src/commands/enter.js',
            'web_editor/static/lib/tele-editor/src/commands/shiftEnter.js',
            'web_editor/static/lib/tele-editor/src/commands/shiftTab.js',
            'web_editor/static/lib/tele-editor/src/commands/tab.js',
            'web_editor/static/lib/tele-editor/src/commands/toggleList.js',
        ...
        'web.assets_common': [
            'web_editor/static/lib/tele-editor/src/base_style.css',
            'web_editor/static/lib/vkbeautify/**/*',
            'web_editor/static/src/js/common/**/*',
            'web_editor/static/lib/tele-editor/src/utils/utils.js',
        ],
        'web.assets_backend': [
