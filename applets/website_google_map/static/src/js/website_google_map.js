...
function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('tele-google-map'), {
        zoom: 1,
    ...
    if (tele_partner_data){ /* tele_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < tele_partner_data.counter; i++) {
            set_marker(tele_partner_data.partners[i]);
        }
