...
/**
  * This file should be used in the context of an external widget loading (e.g: live chat in a non-Tele website)
  ...
  * As we're not in an Tele website context, the calls will not work, and we avoid a 404 request.
  */
