...
from tele import Command, tools
from tele.applets.mail_group.tests.data import GROUP_TEMPLATE
from tele.applets.mail_group.tests.common import TestMailListCommon
from tele.exceptions import AccessError
from tele.tests.common import tagged, users
...
class TestMailGroupModeration(TestMailListCommon):
    ...
    @mute_logger('tele.models.unlink', 'tele.applets.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('tele.applets.base.models.ir_rule', 'tele.applets.base.models.ir_model')
...
class TestModeration(TestMailListCommon):
    ...
    @mute_logger('tele.applets.mail.models.mail_thread', 'tele.applets.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('tele.applets.mail.models.mail_thread', 'tele.applets.mail_group.models.mail_group_message', 'tele.models.unlink')
    @users('employee')
    ...
    @mute_logger('tele.applets.mail_group.models.mail_group')
    @users('employee')
