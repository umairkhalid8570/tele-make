...
class AdyenForm(AdyenCommon):
    ...
    def test_processing_values(self):
        ...
        with mute_logger('tele.applets.payment.models.payment_transaction'), \
            patch(
                'tele.applets.payment.utils.generate_access_token',
        ...
        with patch(
            'tele.applets.payment.utils.generate_access_token', new=self._generate_test_access_token
        ):
    ...
    @mute_logger('tele.applets.payment_adyen.models.payment_transaction')
    def test_send_refund_request(self):
        ...
        with patch(
            'tele.applets.payment_adyen.models.payment_acquirer.PaymentAcquirer._adyen_make_request',
