...
FormRenderer.include({
    ...
    destroy() {
        ...
        twl.Component.env.bus.off('mail.thread:promptAddFollower-closed', this);
    },
    ...
    _makeChatterContainerComponent() {
        ...
        if (this.chatterFields.hasRecordReloadOnFollowersUpdate) {
            twl.Component.env.bus.on('mail.thread:promptAddFollower-closed', this, ev => this.trigger_up('reload', { keepChanges: true }));
        }
    },
    /**
     * @private
