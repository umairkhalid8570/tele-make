...
QUnit.test('sidebar: chat custom name', async function (assert) {
    ...
    this.data['res.partner'].records.push({ id: 101, name: "Tele Demo" });
    // chat expected to be found in the sidebar
    this.data['mail.channel'].records.push({
        channel_type: 'chat', // testing a chat is the goal of the test
...
QUnit.test('receive new chat message: out of tele focus (notification, channel)', async function (assert) {
    assert.expect(4);
    ...
    // simulate receiving a new message with tele focused
    await afterNextRender(() => {
        this.widget.call('bus_service', 'trigger', 'notification', [{
...
QUnit.test('receive new chat message: out of tele focus (notification, chat)', async function (assert) {
    assert.expect(4);
...
QUnit.test('receive new chat messages: out of tele focus (tab title)', async function (assert) {
    assert.expect(12);
    ...
    // simulate receiving a new message in chat 20 with tele focused
    await afterNextRender(() => {
        this.widget.call('bus_service', 'trigger', 'notification', [{
            type: 'mail.channel/new_message',
            payload: {
    ...
    // simulate receiving a new message in chat 10 with tele focused
    await afterNextRender(() => {
        this.widget.call('bus_service', 'trigger', 'notification', [{
            type: 'mail.channel/new_message',
            payload: {
    ...
    // simulate receiving another new message in chat 10 with tele focused
    await afterNextRender(() => {
        this.widget.call('bus_service', 'trigger', 'notification', [{
            type: 'mail.channel/new_message',
            payload: {
