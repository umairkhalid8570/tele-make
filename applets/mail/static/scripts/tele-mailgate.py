...
# tele-mailgate
#
# This program will read an email from stdin and forward it to tele. Configure
...
def main():
    ...
    op.add_option("-d", "--database", dest="database", help="Tele database name (default: %default)", default='tele')
