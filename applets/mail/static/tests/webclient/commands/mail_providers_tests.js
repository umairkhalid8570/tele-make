...
QUnit.module('mail', {}, function () {
    ...
    QUnit.test('open the chatWindow of a user from the command palette', async function (assert) {
        ...
        this.data['res.partner'].records.push(
            { id: 11, name: "Partner 1", email: "p1@tele.studio" },
            { id: 12, name: "Partner 2", email: "p2@tele.studio" },
            { id: 13, name: "Partner 3", email: "p3@tele.studio" },
        );
        ...
        assert.deepEqual(
            ...
            [
                "Partner 1p1@tele.studio",
                "Partner 2p2@tele.studio",
                "Partner 3p3@tele.studio",
            ]
        );
