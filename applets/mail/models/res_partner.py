...
from tele.applets.bus.models.bus_presence import AWAY_TIMER
from tele.applets.bus.models.bus_presence import DISCONNECTION_TIMER
...
class Partner(models.Model):
    ...
    def _compute_im_status(self):
        ...
        telebot = self.env['res.partner'].browse(telebot_id)
        if telebot in self:
            telebot.im_status = 'bot'
