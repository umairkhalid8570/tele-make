tele.define("base_backend_theme.website_apps_menu", function (require) {
    "use strict";
    /*
     * We can't require anything from website here because `base_backend_theme` doesn't depend on `website`.
