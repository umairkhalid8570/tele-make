...
<t t-set="httpurl" t-value="'https://www.tele.eu'"/>
Website0: <a id="url0" t-attf-href="https://www.tele.tz/my/{{object.name}}">https://www.tele.tz/my/<t t-esc="object.name"/></a>
Website1: <a id="url1" href="https://www.tele.be">https://www.tele.be</a>
...
Email: <a id="url5" href="mailto:test@tele.studio">test@tele.studio</a></div>""",
            'mailing_model_id': self.env['ir.model']._get('mailing.list').id,
            'reply_to_mode': 'new',
            'reply_to': self.email_reply_to,
            'contact_list_ids': [(6, 0, self.mailing_list_1.ids)],
        ...
        for contact in self.mailing_list_1.contact_ids:
            ...
            for link_info in [('url0', 'https://www.tele.tz/my/%s' % contact.name, True),
                              ...
                              ('url5', 'mailto:test@tele.studio', False)]:
