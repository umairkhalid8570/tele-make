tele.define('point_of_sale.tour.PosHr', function (require) {
    'use strict';
    ...
    SelectionPopup.check.hasSelectionItem('Tele Admin');
    ...
    SelectionPopup.do.clickItem('Tele Admin');
    PosHr.check.cashierNameIs('Tele Admin');
    ...
    Chrome.do.clickTicketButton();
    TicketScreen.check.nthRowContains(4, 'Tele Admin');
