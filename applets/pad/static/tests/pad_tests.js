tele.define('pad.pad_tests', function (require) {
"use strict";
...
QUnit.module('pad widget', {
        ...
        this.data = {
            task: {
                ...
                records: [
                    ...
                    {id: 2, description: "https://pad.tele.pad/p/test-03AK6RCJT"},
                ],
                ...
                pad_generate_url: function (route, args) {
                    return {
                        url:'https://pad.tele.pad/p/test/' + args.context.object_id
                    };
                },
    ...
    QUnit.test('pad widget works, basic case', async function (assert) {
        ...
        var form = await createView({
            ...
            res_id: 1,
            mockRPC: function (route, args) {
                if (route === 'https://pad.tele.pad/p/test/1?showChat=false&userName=batman') {
            ...
            mockRPC: function (route, args) {
                ...
                if (args.method === "write") {
                    assert.strictEqual(args.args[1].description,
                        "https://pad.tele.pad/p/test-03AK6RCJT");
                }
                return this._super.apply(this, arguments);
            },
        });
