...
iap_patch = patch('tele.applets.iap.tools.iap_tools.iap_jsonrpc', iap_jsonrpc_mocked)
...
_MAIL_DOMAIN_BLACKLIST = set([
    ...
    'wp.pl', 'hotmail.it', 'live.com.mx', 'zoho.com', 'live.co.uk', 'sohu.com', 'twoomail.com', 'yahoo.com.sg', 'tele.studio', 'yahoo.com.vn',
    ...
    'bk.ru', 'mail.tele.studio', 'gmail.con', 'fiu.edu', 'gmal.com', 'useemlikefun.com', 'google.com', 'trbvn.com', 'yopmail.com', 'ya.ru',
