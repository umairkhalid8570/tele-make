...
class TeleDashboardNinjaTemplate(models.Model):
    _name = 'tele_dashboard_ninja.board_defined_filters'
    _description = 'Dashboard Ninja Defined Filters'

    name = fields.Char("Filter Label")
    tele_dashboard_board_id = fields.Many2one('tele_dashboard_ninja.board', string="Dashboard")
...
class TeleDashboardNinjaTemplate(models.Model):
    _name = 'tele_dashboard_ninja.board_custom_filters'
