...
class TeleDashboardNInjaImport(models.TransientModel):
    _name = 'tele_dashboard_ninja.import'
    ...
    def tele_do_action(self):
        for rec in self:
            try:
                ...
                self.env['tele_dashboard_ninja.board'].tele_import_dashboard(tele_result, self.tele_top_menu_id)
                return {
