tele.define('partner_autocomplete.tests', function (require) {
    "use strict";
            ...
            _.each(fieldsToPatch, function (fieldToPatch) {
                testUtils.mock.patch(fieldToPatch, {
                    _getBase64Image: function (url) {
                        return Promise.resolve(url === "tele.studio/logo.png" ? "telebase64" : "");
                    },
                    _isOnline: function () {
                        return true;
                    },
                    ...
                    _getTeleSuggestions: function (value, isVAT) {
                    ...
                    _getClearbitSuggestions: function (value) {
                        return this._getTeleSuggestions(value);
                    },
    ...
    QUnit.test("Partner autocomplete : Company type = Individual", function (assert) {
        ...
        createView({
            ...
            testUtils.fields.editInput($input, "tele")
        ...
        var form = await createView({
            ...
            mockRPC: function (route) {
                if (route === "/web/static/img/placeholder.png"
                    || route === "tele.studio/logo.png"
                    || route === "data:image/png;base64,telebase64") { // land here as it is not valid base64 content
            ...
            await testUtils.fields.editInput($input, "tele");
            ...
            assert.strictEqual($input.val(), "Tele", "Input value should have been updated to \"Tele\"");
            assert.strictEqual(form.$("input.o_field_widget").val(), "tele.studio", "website value should have been updated to \"tele.studio\"");
            ...
            await testUtils.nextTick();
            $dropdown = form.$(".o_field_partner_autocomplete .dropdown-menu:visible");
            assert.strictEqual($dropdown.length, 1, "there should be an opened dropdown when typing tele letters again");
