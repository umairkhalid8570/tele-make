...
class EventDtPatcher(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.event_dt = patch(
            'tele.applets.event.models.event_event.fields.Datetime',
            wraps=FieldsDatetime
        )
        cls.wevent_dt = patch(
            'tele.applets.website_event.models.event_event.fields.Datetime',
            wraps=FieldsDatetime
        )
        cls.wevent_main_dt = patch(
            'tele.applets.website_event.controllers.main.fields.Datetime',
            wraps=FieldsDatetime
        )
        cls.event_date = patch(
            'tele.applets.event.models.event_event.fields.Date',
            wraps=FieldsDate
        )
        cls.wevent_main_date = patch(
            'tele.applets.website_event.controllers.main.fields.Date',
            wraps=FieldsDate
        )
