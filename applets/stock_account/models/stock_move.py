...
from tele.tools import float_is_zero, OrderedSet
...
class StockMove(models.Model):
    ...
    def _account_entry_move(self, qty, description, svl_id, cost):
        ...
        if self.company_id.anglo_saxon_accounting:
            # Creates an account entry from stock_input to stock_output on a dropship move. https://github.com/tele-studio/tele/issues/12687
