...
from tele.tools import float_is_zero, float_repr, float_round, float_compare
...
class ProductProduct(models.Model):
    ...
    def _create_fifo_vacuum_anglo_saxon_expense_entry(self, vacuum_svl, svl_to_vacuum):
        """ When product is delivered and invoiced while you don't have units in stock anymore, there are chances of that
            ...
            You assumed the missing 2 should go out at a value of 10$ but you are not sure yet as it hasn't been bought in Tele yet.
