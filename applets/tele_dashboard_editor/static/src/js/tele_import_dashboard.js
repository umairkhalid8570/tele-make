tele.define('tele_dashboard_editor.import_button', function(require) {
...
//    var Sidebar = require('web.Sidebar');
    ...
    ListController.include({
       ...
       _getActionMenuItems: function (state) {
        ...
        if (this.modelName == "tele_dashboard_editor.board"){
    ...
    core.action_registry.add('tele_dashboard_editor.import_button', ListController);
