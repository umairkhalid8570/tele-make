...
class TeleDashboardJsonExport(TeleDashboardExport, http.Controller):
    ...
    @http.route('/tele_dashboard_editor/export/dashboard_json', type='http', auth="user")
    @serialize_exception
    def index(self, data):
...
class TeleItemJsonExport(TeleDashboardExport, http.Controller):
    ...
    @http.route('/tele_dashboard_editor/export/item_json', type='http', auth="user")
    @serialize_exception
    def index(self, data):
        data = json.loads(data)
        item_id = data["item_id"]
        data['dashboard_data'] = request.env['tele_dashboard_editor.board'].tele_export_item(item_id)
