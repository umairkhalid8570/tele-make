...
class TestUi(TestUICommon):
    ...
    def test_course_member_employee(self):
        ...
        self.browser_js(
            '/slides',
            'tele.__DEBUG__.services["web_tour.tour"].run("course_member")',
            'tele.__DEBUG__.services["web_tour.tour"].tours.course_member.ready',
    ...
    def test_full_screen_edition_website_publisher(self):
        ...
        self.browser_js(
            '/slides',
            'tele.__DEBUG__.services["web_tour.tour"].run("full_screen_web_editor")',
            'tele.__DEBUG__.services["web_tour.tour"].tours.full_screen_web_editor.ready',
            login=user_demo.login)
...
class TestUiYoutube(HttpCaseWithUserDemo):
    ...
    def test_course_member_yt_employee(self):
        ...
        self.browser_js(
            '/slides',
            'tele.__DEBUG__.services["web_tour.tour"].run("course_member_youtube")',
            'tele.__DEBUG__.services["web_tour.tour"].tours.course_member_youtube.ready',
            login=user_demo.login)
    ...
    def test_course_publisher_elearning_manager(self):
        ...
        self.browser_js(
            '/slides',
            'tele.__DEBUG__.services["web_tour.tour"].run("course_publisher")',
            'tele.__DEBUG__.services["web_tour.tour"].tours.course_publisher.ready',
            login=user_demo.login)
