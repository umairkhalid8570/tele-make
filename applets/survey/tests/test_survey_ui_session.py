...
from tele.tests.common import tagged, HttpCase
...
class TestUiSession(HttpCase):
    ...
    def test_admin_survey_session(self):
        ...
        with patch('tele.applets.survey.models.survey_survey.Survey.action_open_session_manager', action_open_session_manager_mock):
