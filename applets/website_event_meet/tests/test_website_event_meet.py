...
class TestWebsiteEventMeet(TestEventCommon):
    ...
    def test_meeting_room_copy(self):
        ...
        self.assertEqual(meeting_room_1.room_name, 'tele-room-test-meeting-room')
        meeting_room_2 = meeting_room_1.copy()
        self.assertEqual(meeting_room_2.room_name, 'tele-room-test-meeting-room-1')
        ...
        self.assertEqual(meeting_room_3.room_name, 'tele-room-test-meeting-room-2')
