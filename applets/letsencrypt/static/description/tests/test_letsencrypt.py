...
from tele.tests import SingleTransactionCase
...
class TestLetsencrypt(SingleTransactionCase):
    ...
    @mock.patch("tele.applets.letsencrypt.models.letsencrypt.DNSUpdate")
    ...
    @mock.patch(
        "tele.applets.letsencrypt.models.letsencrypt.Letsencrypt._generate_key",
