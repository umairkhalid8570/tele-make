tele.define('hr_expense.expenses.tree', function (require) {
"use strict";
    ...
    const ExpenseQRCodeMixin = {
        async _renderView() {
            ...
            const google_url = "https://play.google.com/store/apps/details?id=com.tele.mobile";
            const apple_url = "https://apps.apple.com/be/app/tele/id1272543640";
            const action_desktop = {
                name: 'Download our App',
                type: 'ir.actions.client',
                tag: 'expense_qr_code_modal',
                params: {'url': "https://apps.apple.com/be/app/tele/id1272543640"},
                target: 'new',
            };
