...
from tele import SUPERUSER_ID, _, api, fields, models
...
from tele.tools import DEFAULT_SERVER_DATETIME_FORMAT, format_datetime
...
class PickingType(models.Model):
    ...
    show_reserved = fields.Boolean(
        ...
        help="If this checkbox is ticked, Tele will automatically pre-fill the detailed "
