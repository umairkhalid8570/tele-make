...
from tele import SUPERUSER_ID, _, api, fields, models, registry
from tele.exceptions import UserError
from tele.osv import expression
from tele.tools import float_compare, float_is_zero, html_escape
from tele.tools.misc import split_every
...
class StockRule(models.Model):
    ...
    def _get_lead_days(self, product, **values):
        ...
        :type product: :class:`~tele.applets.product.models.product.ProductProduct`
...
class ProcurementGroup(models.Model):
    ...
    def run(self, procurements, raise_user_error=True):
        ...
        :type list: list of `~tele.applets.stock.models.stock_rule.ProcurementGroup.Procurement`
