...
from tele.applets.crm.tests.test_crm_lead_assignment import TestLeadAssignCommon
...
class TestLeadAssignPerf(TestLeadAssignCommon):
    ...
    @mute_logger('tele.models.unlink', 'tele.applets.crm.models.crm_team', 'tele.applets.crm.models.crm_team_member')
