 ...
 * 1 year          month
 * 1 year          quarter
 * 1 year          year    # we are not using a greater time period in Tele (yet)
 ...
 * @param {string} minGranularity granularity of the smallest time interval used in Tele for this
 *                                type
 */
