...
from tele.tools import html2plaintext, cleanup_xml_node
...
class AccountEdiXmlUBL20(models.AbstractModel):
    ...
    def _get_invoice_line_allowance_vals_list(self, line):
        ...
        Note that allowance charges do not exist for credit notes in UBL 2.0, so if we apply discount in Tele
        ...
        allowance_vals = {
            ...
            # A reason should be provided. In Tele, we only manage discounts.
