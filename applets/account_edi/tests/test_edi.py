...
from tele.applets.account_edi.tests.common import AccountEdiTestCommon, _mocked_post_two_steps, _generate_mocked_needs_web_services, _mocked_cancel_failed, _generate_mocked_support_batching
from unittest.mock import patch
from tele.applets.base.tests.test_ir_cron import CronMixinCase
...
class TestAccountEdi(AccountEdiTestCommon, CronMixinCase):
    ...
    def test_prepare_jobs(self):
        ...
        with patch('tele.applets.account_edi.models.account_edi_format.AccountEdiFormat._support_batching', return_value=True):
            to_process = edi_docs._prepare_jobs()
    ...
    @patch('tele.applets.account_edi.models.account_edi_format.AccountEdiFormat._post_invoice_edi', return_value={})
    def test_warning_is_retried(self, patched):
        with patch('tele.applets.account_edi.models.account_edi_format.AccountEdiFormat._needs_web_services',
