...
from tele.applets.website_event_exhibitor.tests.common import TestEventExhibitorCommon
...
class TestSponsorData(TestEventExhibitorCommon):
    ...
    def setUpClass(cls):
        ...
        cls.wevent_exhib_dt = patch(
            'tele.applets.website_event_exhibitor.models.event_sponsor.fields.Datetime',
