tele.define('lunch.lunchKanbanTests', function (require) {
"use strict";
...
QUnit.module('LunchKanbanView', {
    beforeEach() {
        ...
        this.data = {
            ...
            'res.users': {
                ...
                records: [
                    {id: 1, name: "Tele Admin", groups_id: []},
                    {id: 2, name: "Tele Demo", groups_id: []},
    ...
    QUnit.module('LunchWidget', function () {
        ...
        QUnit.test('regular user', async function (assert) {
            ...
            assert.strictEqual($widgetFirstColumn.find('.o_lunch_user_field').text().trim(), "Tele Demo",
                "should have 'Tele Demo' in the user field");
        ...
        QUnit.test('manager user', async function (assert) {
            ...
            assert.strictEqual($userInput.val(), "Tele Admin",
                "should have 'Tele Admin' as value in user field");
