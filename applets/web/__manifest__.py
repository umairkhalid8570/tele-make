...

{
    ...
    'version': '1.0',
    'description': """
Tele Web core module.
========================

This module provides the core of the Tele Web Client.
""",
    'depends': ['base'],
    'auto_install': True,
    'data': [
    ...
    'assets': {
        ...
        'web._assets_common_styles': [
            ...
            'web/static/src/legacy/scss/web.zoomtele.scss',
        ...
        'web._assets_common_scripts': [
            ...
            'web/static/src/legacy/js/libs/zoomtele.js',
            ...
            'web/static/src/legacy/js/core/twl_dialog.js',
