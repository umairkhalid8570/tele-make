...
from tele.modules.module import read_manifest
from tele.tools import mute_logger

_logger = logging.getLogger(__name__)


class TestAssetsGenerateTimeCommon(tele.tests.TransactionCase):
    ...
    def generate_bundles(self):
        ...
        for bundle in bundles:
            with mute_logger('tele.applets.base.models.assetsbundle'):
...
@tele.tests.tagged('post_install', '-at_install', '-standard', 'bundle_generation')
