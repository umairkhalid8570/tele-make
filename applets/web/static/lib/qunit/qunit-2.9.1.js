...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("TeleBeforeTestHook", "TeleAfterTestHook"); // Tele customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("TeleBeforeTestHook"); // Tele customization
  	...
  	finish: function finish() {
        ...
        emit("TeleAfterTestHook", this); // Tele customization
