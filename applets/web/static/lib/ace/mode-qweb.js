    ...
    var QWebHighlightRules = function () {
        ...
        this.$rules = Object.assign({},
            xmlRules,
            {
                ...
                attributes_tele: [{
                    token: ["entity.other.attribute-name.xml.tele", "keyword.operator.attribute-equals.xml", "text", "string.attribute-value.xml.start", "string.attribute-value.xml.code", "string.attribute-value.xml.end"],
