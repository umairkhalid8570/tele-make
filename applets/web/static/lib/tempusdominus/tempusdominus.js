...
var DateTimePicker = function ($, moment) {
    ...
    var NAME = 'datetimepicker',
        ...
        Selector = {
        // /!\ TELE PATCH: ensure the datetimepickers can be toggled only after
        // the Tele lazy loader finished loading all lazy scripts. Another
    ...
    var DateTimePicker = function () {
        ...
        DateTimePicker.prototype._change = function _change(e) {
            ...
            this._setValue(parsedDate, 0); // Tele FIX: if a valid date is replaced by an invalid one, lib will crash, see https://github.com/tempusdominus/bootstrap-4/issues/223
        ...
        DateTimePicker.prototype._notifyEvent = function _notifyEvent(e) {
            // /!\ TELE FIX: these next conditions have been modified by tele
        ...
        DateTimePicker.prototype._getLastPickedDate = function _getLastPickedDate() {
            return this._dates[this._getLastPickedDateIndex()] || this.getMoment(); // FIXME changed by Tele
        };
...
var TempusDominusBootstrap4 = function ($) {
    ...
    var TempusDominusBootstrap4 = function (_DateTimePicker) {
        ...
        TempusDominusBootstrap4.prototype._place = function _place(e) {
            ...
            // /!\ TELE FIX: the 3 next lines have been *added* by tele
    ...
    */
    ...
    $(document).on(DateTimePicker.Event.CLICK_DATA_API, DateTimePicker.Selector.DATA_TOGGLE, function () {
        ...
        // /!\ TELE FIX: check on 'config' existence added by tele
