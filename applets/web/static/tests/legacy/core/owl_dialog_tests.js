        ...
        QUnit.test("Rendering of all props", async function (assert) {
            ...
            Parent.template = xml`
                <Dialog
                    ...
                    <t t-set="buttons">
                        <button class="btn btn-primary rounded-sm" t-on-click="_onButtonClicked">The Button</button>
                    </t>
                </Dialog>`;
            ...
            assert.containsNone(document.body, '.modal-backdrop'); // No backdrop *element* for Tele modal...
            ...
            // Title (default: 'Tele')
            assert.strictEqual(dialog.querySelector('h4.modal-title').innerText.trim(), "Tele" + "The Subtitle",
