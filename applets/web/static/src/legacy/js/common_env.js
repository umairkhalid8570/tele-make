tele.define("web.commonEnv", function (require) {
    "use strict";

    /**
     * This file defines the common environment, which contains everything that
     * is needed in the env for both the backend and the frontend (Tele
     ...
     * on environments.
     *
     * [1] https://github.com/tele-studio/twl/blob/master/doc/reference/environment.md#content-of-an-environment
     */
    ...
    const env = {
        ...
        device,
        isDebug,
        qweb: new twl.QWeb({ translateFn: _t }),
        services: {
            ajaxJsonRPC() {
