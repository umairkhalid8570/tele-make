tele.define('web.concurrency', function (require) {
"use strict";
 ...
 * everything concurrency related in Tele.
 *
 * The basic concurrency primitives in Tele JS are the callback, and the
