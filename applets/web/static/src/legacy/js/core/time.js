tele.define('web.time', function (require) {
"use strict";
 ...
 * datetime in the Tele Server format.
 *
 ...
 * 
 * The Tele times are supposed to always be naive times. We assume it is
...
/**
 * Converts a Date javascript object to a string using Tele's
 * datetime string format (exemple: '2011-12-01 15:12:35').
 * 
 * The time zone of the Date object is assumed to be the one of the
 * browser and it will be converted to UTC (standard for Tele 6.1).
 * 
 * @param {Date} obj
...
var normalize_format_table = {
    ...
    // See telecms/applets/base/views/res_lang_views.xml
