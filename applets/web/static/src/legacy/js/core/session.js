tele.define('web.Session', function (require) {
"use strict";
...
var Session = core.Class.extend(mixins.EventDispatcherMixin, {
    ...
    /**
     * Load additional web applets of that instance and init them
     *
     */
    ...
    load_qweb: function () {
        return this.qweb_mutex.exec(async () => {
            let templates;
            if (tele.loadTemplatesPromise) {
                templates = await tele.loadTemplatesPromise;
            } else {
