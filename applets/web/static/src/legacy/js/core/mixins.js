tele.define('web.mixins', function (require) {
"use strict";
...
function TeleEvent(target, name, data) {
    this.target = target;
    this.name = name;
...
TeleEvent.prototype.stopPropagation = function () {
    this.stopped = true;
};

TeleEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = _.extend({}, ParentedMixin, {
    ...
    trigger_up: function (name, info) {
        var event = new TeleEvent(this, name, info);
