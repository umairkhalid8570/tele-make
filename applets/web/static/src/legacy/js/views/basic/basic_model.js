tele.define('web.BasicModel', function (require) {
"use strict";
 ...
 * - model is the actual name of a (tele) model, such as 'res.partner'
...
var BasicModel = AbstractModel.extend({
     ...
     * 'save' will bypass the mutex. This is useful when we are leaving Tele
     * (closing tab/browser), and we want to quickly save pending changes (in
     * an 'onbeforeunload' handler, which is mostly sync).
     *
     * This function should never be called except when we are leaving Tele.
     *
