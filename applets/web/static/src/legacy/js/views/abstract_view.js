/** @tele-module alias=web.AbstractView **/

/**
 * This is the base class inherited by all (JS) views. Tele JS views are the
 ...
 * the word 'view' has historical significance in Tele code, so we replaced the
