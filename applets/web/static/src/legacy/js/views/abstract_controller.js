/** @tele-module alias=web.AbstractController **/

/**
 * The Controller class is the class coordinating the model and the renderer.
 * It is the C in MVC, and is what was formerly known in Tele as a View.
 *
...
var AbstractController = mvc.Controller.extend(ActionMixin, {
    ...
    on_attach_callback: function () {
        ...
        if (!(this.renderer instanceof twl.Component)) {
    ...
    /**
     * When an Tele event arrives requesting a record to be opened, this method
