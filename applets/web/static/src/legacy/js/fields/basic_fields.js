/* global ace */
tele.define('web.basic_fields', function (require) {
"use strict";
...
var FieldDateRange = InputField.extend({
    ...
    _applyChanges: function (ev, picker) {
        ...
        if (this.isDateField) {
            ...
            // time at 00:00:00. So, Tele will consider it as UTC. To fix this added browser
...
var JournalDashboardGraph = AbstractField.extend({
    ...
    _getLineChartConfig: function () {
        ...
        var borderColor = this.data[0].is_sample_data ? '#dddddd' : '#136dc7';
